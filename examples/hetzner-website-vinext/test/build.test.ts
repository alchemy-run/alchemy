/**
 * Local vinext production build + Node serve entry. No Hetzner account: this is `vinext build` plus the generated `serve-node.mjs`, the same program Hetzner.Website.Vinext deploys.
 */
...
const GREETING = "Hello from vinext on Hetzner!";
