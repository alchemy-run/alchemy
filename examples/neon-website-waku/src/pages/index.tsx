...
export default async function HomePage() {
  ...
  // way to reach env values from RSC page modules. On Neon it is backed by
  // the Neon Functions runtime's `process.env`.
...
// Dynamic: rendered by the Neon Functions runtime at request time.
