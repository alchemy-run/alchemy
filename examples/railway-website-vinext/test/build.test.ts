/**
 * Local vinext production build + Node serve entry. No Railway account:
 * this is `vinext build` plus the generated `serve-node.mjs`, the same
 * program Railway.Website.Vinext deploys.
 */
...
const GREETING = "Hello from vinext on Railway!";
