...
import * as Cloud from "alchemy/Fly";
...
test.provider(
  ...
  (stack) =>
    Effect.gen(function* () {
      ...
      expect(home).toContain("Hello from vinext on Fly!");
      ...
      yield* Effect.acquireUseRelease(
        fs.writeFileString(page, source.replace("Hello from vinext on Fly!", marker)),
        () =>
      ...
      expect(restored).toContain("Hello from vinext on Fly!");
