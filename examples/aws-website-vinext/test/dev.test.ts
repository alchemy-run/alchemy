...
import * as Cloud from "alchemy/AWS";
...
test.provider(
  ...
  (stack) =>
    Effect.gen(function* () {
      ...
      expect(home).toContain("Hello from vinext on AWS!");
      ...
      yield* Effect.acquireUseRelease(
        fs.writeFileString(page, source.replace("Hello from vinext on AWS!", marker)),
        () =>
      ...
      expect(restored).toContain("Hello from vinext on AWS!");
