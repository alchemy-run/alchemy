/**
 * Local vinext production build + Node serve entry. No AWS account: this is `vinext build` plus the Node serve entry. AWS.Website.Vinext wraps the same App Router build as a Lambda handler.
 */
...
const GREETING = "Hello from vinext on AWS!";
