...
// deploy target's configuration (read by @alchemy.run/frameworks/waku via
...
export default Options.make({
  target: {
    cloudflare: {
      worker: {
        // `main` and `viteEnvironments` are pinned by @alchemy.run/frameworks/waku's
  ...
  // string form (`framework: "@alchemy.run/frameworks/waku"`) is equivalent minus
  // the extra option.
