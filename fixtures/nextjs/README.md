...
E2e fixture for `@alchemy.run/frameworks/nextjs` — the wrangler-free Next.js
...
- `wrangler` resolves to the inert stub in
  `packages/frameworks/nextjs/wrangler-stub` — only its `package.json` version field is
