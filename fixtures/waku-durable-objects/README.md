...
E2e fixture for `@alchemy.run/frameworks/waku` exercising a **framework site plus the
...
`packages/frameworks/core/src/DeployTarget.ts` and the "user-entry seam"
section of `packages/frameworks/core/README.md`).
