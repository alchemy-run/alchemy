...
/**
 * The org's ONE D1 database — the book of record on Cloudflare for
 * anything relational the Durable Objects don't own. The resource IS
 * the export (memoized by FQN): every Layer that yields this const and
