...
// NOTE: Git.Workspaces is deliberately ABSENT too — the worktree join
// moved to the entrypoint's `Workspace.perRun({ remote })` layer.
const _negative: MergePullRequest extends Req ? false : true = true;

export { _coding, _kernel, _negative, _notAny, _openPr };
