...
/**
 * A component import detected in the Layout.vue file
 */
interface ComponentImport {
  /**
   * Name of the component as used in the import statement
   */
  name: string;
  ...
  /**
   * Inferred purpose/description of the component based on its name
   */
  purpose: string;
}
