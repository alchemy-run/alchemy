...
Get up and running with Alchemy in minutes. This guide deploys a simple Cloudflare Worker and walks through the complete development cycle.

## Prerequisites

- [Bun](https://bun.sh/), [Node](https://nodejs.org/en), or [Deno](https://deno.com/)
