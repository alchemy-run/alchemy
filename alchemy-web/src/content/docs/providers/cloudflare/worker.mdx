...
import workerHandlerCode from '../../../../../../examples/cloudflare-worker-simple/src/worker1.ts?raw'
...
For a more complete example with error handling and different response types:

<Code lang="ts" title="worker1.ts" code={workerHandlerCode} />
...
:::tip
See the [WranglerJson](/providers/cloudflare/wranglerjson/) documentation for more details on configuration options.
:::
