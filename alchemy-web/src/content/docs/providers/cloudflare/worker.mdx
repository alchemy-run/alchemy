...
export const worker = await Worker("api", {
  ...
  cwd: "./src",                           // Project root directory (defaults to process.cwd())
  ...
  bindings: {
    ...
    API_KEY: "secret-value"               // Plain-text env binding (converted to plain_text)
  ...
  namespace: "dispatch-namespace",        // Dispatch namespace for Workers for Platforms
