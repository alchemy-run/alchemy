---
title: Prisma D1
description: Build a full-stack application with Prisma ORM and Cloudflare D1 Database using Alchemy for type-safe database operations.
sidebar:
  order: 16
---
...
Build a full-stack application with Prisma ORM and Cloudflare D1 Database. This guide shows you how to set up a type-safe database layer with automated migrations and a web interface using Prisma's powerful schema and client generation.
...
- **Type Safety**: Full TypeScript support with generated Prisma client types
- **Automatic Migrations**: Prisma handles schema changes and database migrations
- **D1 Integration**: Optimized for Cloudflare D1 with the `@prisma/adapter-d1` package
- **Edge Runtime**: Runs on Cloudflare Workers for global low latency
- **Developer Experience**: Rich query API with IntelliSense and compile-time safety
