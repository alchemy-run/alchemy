...
Most Cloudflare bindings are automatically emulated in development mode, such as [`D1Database`](/providers/cloudflare/d1-database), [`KVNamespace`](/providers/cloudflare/kv-namespace), and [`R2Bucket`](/providers/cloudflare/r2):
