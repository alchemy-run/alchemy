...
import {
  ...
  readPackHeader,
  type ResolvedEntry,
} from "../src/git/PackParser.ts";
import { writePackBytes } from "../src/git/PackWriter.ts";
import type { ManifestEntry, ObjectSource } from "../src/git/Store.ts";
import { inflate, inflateEntry } from "../src/git/Zlib.ts";
