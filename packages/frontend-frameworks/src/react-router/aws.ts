 ...
 */
const makeAwsFinishTarget = (config: ReactRouterAwsTargetConfig = {}): ReactRouterAwsTarget =>
  makeDeployTarget({
    platform: "aws",
    config,
    bundle: {
 ...
 * the seams.
 */
export const makeAwsTarget = (config: ReactRouterAwsTargetConfig = {}): ReactRouterAwsTarget => ({
