 ...
 */
const makeAwsFinishTarget = (config: TanStackStartAwsTargetConfig = {}): TanStackStartTarget =>
  makeDeployTarget({
    platform: "aws",
    config,
    bundle: {
 ...
 * the seams.
 */
export const makeAwsTarget = (config: TanStackStartAwsTargetConfig = {}): TanStackStartTarget => ({
