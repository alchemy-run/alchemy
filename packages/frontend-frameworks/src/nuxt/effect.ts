 ...
 *   universal rpc path) and delegates to `alchemy/serve/nitro`'s
 ...
 * delivery module (it imports only `alchemy/serve/nitro` and the site
 ...
 * `alchemy/serve/nitro`'s `toEventHandler`): the explicit-MOUNT marker
