...
/**
 * What a deploy WOULD do — create/adopt moss, update honey, replace/delete
 * brick, orphan muted (it leaves the stack but stays in the cloud).
 */
export const PLAN_COLORS: Record<string, string> = {
  create: "var(--alc-success)",
  update: "var(--alc-warn)",
  adopted: "var(--alc-success)",
  replace: "var(--alc-danger)",
  delete: "var(--alc-danger)",
  orphaned: "var(--alc-muted)",
