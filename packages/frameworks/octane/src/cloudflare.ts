/**
 * `@alchemy.run/frameworks/octane/cloudflare` — the Cloudflare Workers deploy target
 * for `@alchemy.run/frameworks/octane`.
 *
 ...
 */
import { makeDeployTarget } from "@alchemy.run/frameworks/core";
