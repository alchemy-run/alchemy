 ...
 * (`@alchemy.run/frameworks/nextjs/source`).
 *
...
const PROVIDER = "@alchemy.run/frameworks/nextjs/source";
...
/**
 * The JSON-serializable options of the `@alchemy.run/frameworks/nextjs/source`
