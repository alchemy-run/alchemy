# @alchemy.run/frameworks/sveltekit
...
(`@alchemy.run/frameworks/sveltekit/cloudflare`); the framework half of this package
...
`@alchemy.run/frameworks/sveltekit/cloudflare`) implements the contract:
...
import * as SvelteKit from "@alchemy.run/frameworks/sveltekit";

export default Options.make({
  // string form: framework: "@alchemy.run/frameworks/sveltekit"
  framework: (options) =>
...
```ts
// 1. default — omitted: resolves "@alchemy.run/frameworks/sveltekit/cloudflare"
//    from the project's node_modules
SvelteKit.layer({});

// 2. factory — applied to the config the framework assembles from options
import cloudflareTarget from "@alchemy.run/frameworks/sveltekit/cloudflare";
...
| `target`             | `"@alchemy.run/frameworks/sveltekit/cloudflare"`              | Deploy target: value, factory, or module specifier.                                                                         |
