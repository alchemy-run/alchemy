...
describe("parseOutputUrl", () => {
  test("parses aligned and legacy stack output formats", () => {
    expect(parseOutputUrl("  api      http://api.localhost:1234/\n", "api")).toBe(
