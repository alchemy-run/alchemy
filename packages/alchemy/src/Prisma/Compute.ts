...
export type ComputeRuntimeServices = Local.ProcessServices;

export type ComputeShape = Main<ComputeRuntimeServices>;

export interface ComputeRuntimeContext extends Local.ProcessContext {
...
> & {
  ...
  createRuntimeContext: (id): ComputeRuntimeContext => {
    ...
    const run: Local.ProcessContext["run"] = (effect) =>
      Effect.sync(() => {
        runners.push(effect);
      });
