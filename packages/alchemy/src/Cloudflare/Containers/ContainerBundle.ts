 ...
 *
 * Invalid combinations are programmer errors, surfaced as thrown defects
 * (these run inside `Effect.fn` bodies, so a throw dies the plan with the
 * message rather than entering the typed error channel).
 */
