 ...
 */
const NUXT_SOURCE_PROVIDER = "@alchemy.run/frameworks/nuxt/source";
 ...
 *
 * Requires the `@alchemy.run/frameworks/nuxt` package to be installed in your
 * project (alongside `nuxt` itself). Input files are content-hashed
