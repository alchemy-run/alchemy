/**
 * Engine-side Layer factories for the `CloudflareEnvironment` service —
 * profile/OAuth resolution reaches `node:http`/`node:os`, so these live
 * apart from the leaf service module that runtime bridges import.
 */
