 ...
 * one-directional.
 */
import { TEST_LOGGER_CLASS_NAME } from "./constants.ts";

export const LOGGER_WORKER_MAIN_MODULE = "main.js";

export const loggerWorkerScript = `import { DurableObject } from "cloudflare:workers";
