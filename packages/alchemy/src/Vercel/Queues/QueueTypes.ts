 ...
 *
 * Queues are not part of Vercel's management OpenAPI, so these errors are
 * hand-typed from the documented data-plane protocol (and the behavior of
 * `@vercel/queue`), not generated by distilled — see the manual-spec gap
 * noted in `QueueApi.ts`.
 */
