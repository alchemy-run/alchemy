/**
 * Wire protocol between the dev relay (a Worker + Durable Object at the edge)
 ...
 *
 * Shared by the Worker (bundled for workerd) and the Node/Bun connector, so
 * it must stay free of platform imports.
 */
