...
/** SQL files captured during construction and embedded in a runtime bundle. */
export interface SqlMigrationSnapshot {
  /** Retained for compatibility with existing Drizzle migration snapshots. */
...
/** @internal */
export const isSqlMigrationsExport = (
  value: unknown,
): value is SqlMigrationsExport =>
  typeof value === "object" &&
  value !== null &&
  "kind" in value &&
  value.kind === "sqlMigrations";
...
/** Supply embedded records to entrypoint construction and object activation. */
