 ...
 * by `/api/resource`) remains the source for concrete props/attrs.
 */
export interface DashboardPlanNode {
  fqn: string;
  logicalId: string;
  type: string;
  /** the engine's plan action for this resource */
  action: Plan.CRUD["action"];
...
export interface DashboardPlan {
  ...
  /** resources the next apply would delete or orphan */
