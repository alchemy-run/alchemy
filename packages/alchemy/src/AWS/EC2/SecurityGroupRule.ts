              ...
              SecurityGroupRules: [
                {
                  ...
                  SecurityGroupRule: {
                    ...
                    FromPort: news.fromPort,
                    ToPort: news.toPort,
                    CidrIpv4: canonicalSecurityGroupCidr(news.cidrIpv4),
                    CidrIpv6: canonicalSecurityGroupCidr(news.cidrIpv6),
...
const canonicalSecurityGroupCidr = (cidr: string | undefined) => {
