...
export const of = (endpoint: string) => Layer.succeed(Endpoint.Endpoint, Effect.succeed(endpoint));
 ...
 */
export const fromEnvironment: Layer.Layer<never, never, AWSEnvironment> = Layer.effect(
  Endpoint.Endpoint,
  Effect.gen(function* () {
