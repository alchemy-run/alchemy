...
import { makeDocDBElasticClusterHttpBinding, SNAPSHOT_ARN_WILDCARD } from "./BindingHttp.ts";
...
export const CreateClusterSnapshotHttp = Layer.effect(
  ...
  makeDocDBElasticClusterHttpBinding({
    ...
    actions: ["docdb-elastic:CreateClusterSnapshot", "docdb-elastic:TagResource"],
