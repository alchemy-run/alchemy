...
export const providers = () =>
  Layer.effect(
    ...
    Layer.provide(
      Layer.mergeAll(
        Layer.mergeAll(
          flociDual(ACMPCA.CertificateAuthority, () =>
            ACMPCA.CertificateAuthorityProvider(),
          ),
          flociDual(ACMPCA.CertificateAuthorityPolicy, () =>
            ACMPCA.CertificateAuthorityPolicyProvider(),
          ),
          flociDual(ACMPCA.Permission, () => ACMPCA.PermissionProvider()),
          flociDual(AppFlow.ConnectorProfile, () =>
            AppFlow.ConnectorProfileProvider(),
          ),
          flociDual(AppFlow.Flow, () => AppFlow.FlowProvider()),
          flociDual(AppIntegrations.Application, () =>
            AppIntegrations.ApplicationProvider(),
          ),
          flociDual(AppIntegrations.DataIntegration, () =>
            AppIntegrations.DataIntegrationProvider(),
          ),
          flociDual(AppIntegrations.EventIntegration, () =>
            AppIntegrations.EventIntegrationProvider(),
          ),
          flociDual(B2BI.Capability, () => B2BI.CapabilityProvider()),
          flociDual(B2BI.Partnership, () => B2BI.PartnershipProvider()),
          flociDual(B2BI.Profile, () => B2BI.ProfileProvider()),
          flociDual(B2BI.Transformer, () => B2BI.TransformerProvider()),
          flociDual(BedrockDataAutomation.Blueprint, () =>
            BedrockDataAutomation.BlueprintProvider(),
          ),
          flociDual(BedrockDataAutomation.DataAutomationLibrary, () =>
            BedrockDataAutomation.DataAutomationLibraryProvider(),
          ),
          flociDual(BedrockDataAutomation.DataAutomationProject, () =>
            BedrockDataAutomation.DataAutomationProjectProvider(),
          ),
          flociDual(Config.AggregationAuthorization, () =>
            Config.AggregationAuthorizationProvider(),
          ),
          flociDual(Config.ConfigRule, () => Config.ConfigRuleProvider()),
          flociDual(Config.ConfigurationRecorder, () =>
            Config.ConfigurationRecorderProvider(),
          ),
          flociDual(Config.DeliveryChannel, () =>
            Config.DeliveryChannelProvider(),
          ),
          flociDual(Config.RetentionConfiguration, () =>
        ...
        Layer.mergeAll(
          ...
          flociDual(AMP.AlertManagerDefinition, () =>
            AMP.AlertManagerDefinitionProvider(),
          ),
          flociDual(AMP.AnomalyDetector, () => AMP.AnomalyDetectorProvider()),
          flociDual(AMP.LoggingConfiguration, () =>
            AMP.LoggingConfigurationProvider(),
          ),
          flociDual(AMP.QueryLoggingConfiguration, () =>
            AMP.QueryLoggingConfigurationProvider(),
          ),
          flociDual(AMP.ResourcePolicy, () => AMP.ResourcePolicyProvider()),
          ...
          flociDual(ApiGatewayV2.ApiMappingResource, () =>
          ...
          flociDual(AppRunner.AutoScalingConfiguration, () =>
            AppRunner.AutoScalingConfigurationProvider(),
          ),
          flociDual(AppRunner.ObservabilityConfiguration, () =>
            AppRunner.ObservabilityConfigurationProvider(),
          ),
          flociDual(AppRunner.Service, () => AppRunner.ServiceProvider()),
          flociDual(AppRunner.VpcConnector, () =>
          ...
          flociDual(CloudControl.Resource, () =>
            CloudControl.CloudControlResourceProvider(),
          ),
          flociDual(CloudFormation.Stack, () => CloudFormation.StackProvider()),
          ...
          flociDual(CloudHSMV2.Cluster, () => CloudHSMV2.ClusterProvider()),
          flociDual(CloudHSMV2.Hsm, () => CloudHSMV2.HsmProvider()),
          ...
          flociDual(CloudWatch.AlarmMuteRule, () =>
            CloudWatch.AlarmMuteRuleProvider(),
          ),
          flociDual(CloudWatch.Alarm, () => CloudWatch.AlarmProvider()),
          flociDual(CloudWatch.AnomalyDetector, () =>
            CloudWatch.AnomalyDetectorProvider(),
          ),
          flociDual(CloudWatch.CompositeAlarm, () =>
            CloudWatch.CompositeAlarmProvider(),
          ),
          flociDual(CloudWatch.Dashboard, () => CloudWatch.DashboardProvider()),
          flociDual(CloudWatch.InsightRule, () =>
            CloudWatch.InsightRuleProvider(),
          ),
          flociDual(CloudWatch.MetricStream, () =>
            CloudWatch.MetricStreamProvider(),
          ),
          flociDual(CodeArtifact.Domain, () => CodeArtifact.DomainProvider()),
          flociDual(CodeArtifact.Repository, () =>
            CodeArtifact.RepositoryProvider(),
          ),
          flociDual(CodeBuild.Project, () => CodeBuild.ProjectProvider()),
          flociDual(CodeBuild.ReportGroup, () =>
            CodeBuild.ReportGroupProvider(),
          ),
          flociDual(CodeConnections.Connection, () =>
            CodeConnections.ConnectionProvider(),
          ),
          flociDual(CodeConnections.Host, () => CodeConnections.HostProvider()),
          flociDual(CodeConnections.RepositoryLink, () =>
            CodeConnections.RepositoryLinkProvider(),
          ),
          flociDual(CodeConnections.SyncConfiguration, () =>
            CodeConnections.SyncConfigurationProvider(),
          ),
          flociDual(CodeDeploy.Application, () =>
            CodeDeploy.ApplicationProvider(),
          ),
          flociDual(CodeDeploy.DeploymentConfig, () =>
            CodeDeploy.DeploymentConfigProvider(),
          ),
          flociDual(CodeDeploy.DeploymentGroup, () =>
            CodeDeploy.DeploymentGroupProvider(),
          ),
          flociDual(CodePipeline.Pipeline, () =>
        ...
        Layer.mergeAll(
          flociDual(DataBrew.Dataset, () => DataBrew.DatasetProvider()),
          flociDual(DataBrew.Job, () => DataBrew.JobProvider()),
          flociDual(DataBrew.Project, () => DataBrew.ProjectProvider()),
          flociDual(DataBrew.Recipe, () => DataBrew.RecipeProvider()),
          flociDual(DataBrew.Ruleset, () => DataBrew.RulesetProvider()),
          flociDual(DataBrew.Schedule, () => DataBrew.ScheduleProvider()),
          flociDual(DataExchange.DataSet, () => DataExchange.DataSetProvider()),
          flociDual(DataExchange.EventAction, () =>
            DataExchange.EventActionProvider(),
          ),
          flociDual(DataExchange.Revision, () =>
            DataExchange.RevisionProvider(),
          ),
          flociDual(DataSync.LocationEfs, () => DataSync.LocationEfsProvider()),
          flociDual(DataSync.LocationS3, () => DataSync.LocationS3Provider()),
          flociDual(DataSync.Task, () => DataSync.TaskProvider()),
          flociDual(DataZone.Domain, () => DataZone.DomainProvider()),
          flociDual(DataZone.Environment, () => DataZone.EnvironmentProvider()),
          flociDual(DataZone.EnvironmentBlueprintConfiguration, () =>
            DataZone.EnvironmentBlueprintConfigurationProvider(),
          ),
          flociDual(DataZone.Project, () => DataZone.ProjectProvider()),
          flociDual(DAX.Cluster, () => DAX.ClusterProvider()),
          flociDual(DAX.ParameterGroup, () => DAX.ParameterGroupProvider()),
          flociDual(DAX.SubnetGroup, () => DAX.SubnetGroupProvider()),
          flociDual(Deadline.Budget, () => Deadline.BudgetProvider()),
          flociDual(Deadline.Farm, () => Deadline.FarmProvider()),
          flociDual(Deadline.Fleet, () => Deadline.FleetProvider()),
          flociDual(Deadline.Monitor, () => Deadline.MonitorProvider()),
          flociDual(Deadline.Queue, () => Deadline.QueueProvider()),
          flociDual(Deadline.StorageProfile, () =>
            Deadline.StorageProfileProvider(),
          ),
          flociDual(DirectoryService.ConditionalForwarder, () =>
            DirectoryService.ConditionalForwarderProvider(),
          ),
          flociDual(DirectoryService.Directory, () =>
            DirectoryService.DirectoryProvider(),
          ),
          flociDual(DirectoryService.EventTopic, () =>
            DirectoryService.EventTopicProvider(),
          ),
          flociDual(DLM.LifecyclePolicy, () => DLM.LifecyclePolicyProvider()),
          flociDual(DocDB.DBCluster, () => DocDB.DBClusterProvider()),
          flociDual(DocDB.DBInstance, () => DocDB.DBInstanceProvider()),
          flociDual(DocDB.DBSubnetGroup, () => DocDB.DBSubnetGroupProvider()),
          flociDual(DocDBElastic.Cluster, () => DocDBElastic.ClusterProvider()),
          flociDual(DMS.Endpoint, () => DMS.EndpointProvider()),
          flociDual(DMS.ReplicationInstance, () =>
            DMS.ReplicationInstanceProvider(),
          ),
          flociDual(DMS.ReplicationSubnetGroup, () =>
            DMS.ReplicationSubnetGroupProvider(),
          ),
          flociDual(DSQL.Cluster, () => DSQL.ClusterProvider()),
          flociDual(DSQL.ClusterPolicy, () => DSQL.ClusterPolicyProvider()),
          flociDual(DSQL.Stream, () => DSQL.StreamProvider()),
          flociDual(DevOpsGuru.EventSourcesConfig, () =>
            DevOpsGuru.EventSourcesConfigProvider(),
          ),
          flociDual(DevOpsGuru.NotificationChannel, () =>
            DevOpsGuru.NotificationChannelProvider(),
          ),
          flociDual(DevOpsGuru.ResourceCollection, () =>
            DevOpsGuru.ResourceCollectionProvider(),
          ),
          flociDual(DevOpsGuru.ServiceIntegration, () =>
          ...
          flociDual(EFS.AccessPoint, () => EFS.AccessPointProvider()),
          flociDual(EFS.FileSystem, () => EFS.FileSystemProvider()),
          flociDual(EFS.MountTarget, () => EFS.MountTargetProvider()),
          flociDual(EKS.AccessEntry, () => EKS.AccessEntryProvider()),
          flociDual(EKS.Addon, () => EKS.AddonProvider()),
          flociDual(EKS.Cluster, () => EKS.ClusterProvider()),
          flociDual(EKS.FargateProfile, () => EKS.FargateProfileProvider()),
          flociDual(EKS.Nodegroup, () => EKS.NodegroupProvider()),
          flociDual(EKS.PodIdentityAssociation, () =>
          ...
          flociDual(FIS.ExperimentTemplate, () =>
            FIS.ExperimentTemplateProvider(),
          ),
          flociDual(FIS.TargetAccountConfiguration, () =>
            FIS.TargetAccountConfigurationProvider(),
          ),
          flociDual(Firehose.DeliveryStream, () =>
            Firehose.DeliveryStreamProvider(),
          ),
          flociDual(FSx.FileSystem, () => FSx.FileSystemProvider()),
          flociDual(Glacier.Vault, () => Glacier.VaultProvider()),
          ...
          flociDual(Grafana.Workspace, () => Grafana.WorkspaceProvider()),
          flociDual(GreengrassV2.ComponentVersion, () =>
            GreengrassV2.ComponentVersionProvider(),
          ),
          flociDual(GreengrassV2.Deployment, () =>
            GreengrassV2.DeploymentProvider(),
          ),
          flociDual(HealthLake.FHIRDatastore, () =>
        ...
        Layer.mergeAll(
          flociDual(IdentityCenter.AccountAssignment, () =>
            IdentityCenter.AccountAssignmentProvider(),
          ),
          flociDual(IdentityCenter.Group, () => IdentityCenter.GroupProvider()),
          flociDual(IdentityCenter.Instance, () =>
            IdentityCenter.InstanceProvider(),
          ),
          flociDual(IdentityCenter.PermissionSet, () =>
            IdentityCenter.PermissionSetProvider(),
          ),
          flociDual(Kafka.ServerlessCluster, () =>
            Kafka.ServerlessClusterProvider(),
          ),
          flociDual(Kendra.DataSource, () => Kendra.DataSourceProvider()),
          flociDual(Kendra.Index, () => Kendra.IndexProvider()),
          flociDual(Keyspaces.Keyspace, () => Keyspaces.KeyspaceProvider()),
          flociDual(Keyspaces.Table, () => Keyspaces.TableProvider()),
          flociDual(Keyspaces.Type, () => Keyspaces.TypeProvider()),
          ...
          flociDual(KinesisAnalyticsV2.Application, () =>
            KinesisAnalyticsV2.ApplicationProvider(),
          ),
          flociDual(KinesisAnalyticsV2.ApplicationCloudWatchLoggingOption, () =>
            KinesisAnalyticsV2.ApplicationCloudWatchLoggingOptionProvider(),
          ),
          flociDual(KinesisAnalyticsV2.ApplicationSnapshot, () =>
            KinesisAnalyticsV2.ApplicationSnapshotProvider(),
          ),
          flociDual(KinesisVideo.SignalingChannel, () =>
            KinesisVideo.SignalingChannelProvider(),
          ),
          flociDual(KinesisVideo.Stream, () => KinesisVideo.StreamProvider()),
          flociDual(LakeFormation.DataCellsFilter, () =>
            LakeFormation.DataCellsFilterProvider(),
          ),
          flociDual(LakeFormation.DataLakeSettings, () =>
            LakeFormation.DataLakeSettingsProvider(),
          ),
          flociDual(LakeFormation.LFTag, () => LakeFormation.LFTagProvider()),
          flociDual(LakeFormation.LFTagAssociation, () =>
            LakeFormation.LFTagAssociationProvider(),
          ),
          flociDual(LakeFormation.LFTagExpression, () =>
            LakeFormation.LFTagExpressionProvider(),
          ),
          flociDual(LakeFormation.OptIn, () => LakeFormation.OptInProvider()),
          flociDual(LakeFormation.Permissions, () =>
            LakeFormation.PermissionsProvider(),
          ),
          flociDual(LakeFormation.Resource, () =>
          ...
          flociDual(MediaConnect.Flow, () => MediaConnect.FlowProvider()),
          flociDual(MediaConvert.Job, () => MediaConvert.JobProvider()),
          flociDual(MediaConvert.JobTemplate, () =>
            MediaConvert.JobTemplateProvider(),
          ),
          flociDual(MediaConvert.Preset, () => MediaConvert.PresetProvider()),
          flociDual(MediaConvert.Queue, () => MediaConvert.QueueProvider()),
          flociDual(MediaLive.Channel, () => MediaLive.ChannelProvider()),
          flociDual(MediaLive.Input, () => MediaLive.InputProvider()),
          flociDual(MediaLive.InputSecurityGroup, () =>
            MediaLive.InputSecurityGroupProvider(),
          ),
          flociDual(MediaPackageV2.Channel, () =>
            MediaPackageV2.ChannelProvider(),
          ),
          flociDual(MediaPackageV2.ChannelGroup, () =>
            MediaPackageV2.ChannelGroupProvider(),
          ),
          flociDual(MediaPackageV2.OriginEndpoint, () =>
            MediaPackageV2.OriginEndpointProvider(),
          ),
          flociDual(MediaTailor.PlaybackConfiguration, () =>
            MediaTailor.PlaybackConfigurationProvider(),
          ),
          flociDual(MedicalImaging.Datastore, () =>
            MedicalImaging.DatastoreProvider(),
          ),
          flociDual(MQ.Broker, () => MQ.BrokerProvider()),
          flociDual(MQ.Configuration, () => MQ.ConfigurationProvider()),
          flociDual(MailManager.AddonInstance, () =>
            MailManager.AddonInstanceProvider(),
          ),
          flociDual(MailManager.AddonSubscription, () =>
            MailManager.AddonSubscriptionProvider(),
          ),
          flociDual(MailManager.AddressList, () =>
            MailManager.AddressListProvider(),
          ),
          flociDual(MailManager.Archive, () => MailManager.ArchiveProvider()),
          flociDual(MailManager.IngressPoint, () =>
            MailManager.IngressPointProvider(),
          ),
          flociDual(MailManager.Relay, () => MailManager.RelayProvider()),
          flociDual(MailManager.RuleSet, () => MailManager.RuleSetProvider()),
          flociDual(MailManager.TrafficPolicy, () =>
            MailManager.TrafficPolicyProvider(),
          ),
          flociDual(MemoryDB.ACL, () => MemoryDB.ACLProvider()),
          flociDual(MemoryDB.Cluster, () => MemoryDB.ClusterProvider()),
          flociDual(MemoryDB.ParameterGroup, () =>
            MemoryDB.ParameterGroupProvider(),
          ),
          flociDual(MemoryDB.SubnetGroup, () => MemoryDB.SubnetGroupProvider()),
          flociDual(MemoryDB.User, () => MemoryDB.UserProvider()),
          flociDual(Neptune.DBCluster, () => Neptune.DBClusterProvider()),
          flociDual(Neptune.DBClusterParameterGroup, () =>
            Neptune.DBClusterParameterGroupProvider(),
          ),
          flociDual(Neptune.DBInstance, () => Neptune.DBInstanceProvider()),
          flociDual(Neptune.DBParameterGroup, () =>
            Neptune.DBParameterGroupProvider(),
          ),
          flociDual(Neptune.DBSubnetGroup, () =>
            Neptune.DBSubnetGroupProvider(),
          ),
          flociDual(NeptuneGraph.Graph, () => NeptuneGraph.GraphProvider()),
          flociDual(OpenSearch.Domain, () => OpenSearch.DomainProvider()),
          flociDual(OpenSearchServerless.AccessPolicy, () =>
            OpenSearchServerless.AccessPolicyProvider(),
          ),
          flociDual(OSIS.PipelineEndpoint, () =>
            OSIS.PipelineEndpointProvider(),
          ),
          flociDual(OSIS.Pipeline, () => OSIS.PipelineProvider()),
          flociDual(OSIS.ResourcePolicy, () => OSIS.ResourcePolicyProvider()),
          flociDual(OpenSearchServerless.Collection, () =>
            OpenSearchServerless.CollectionProvider(),
          ),
          flociDual(OpenSearchServerless.CollectionGroup, () =>
            OpenSearchServerless.CollectionGroupProvider(),
          ),
          flociDual(OpenSearchServerless.LifecyclePolicy, () =>
            OpenSearchServerless.LifecyclePolicyProvider(),
          ),
          flociDual(OpenSearchServerless.SecurityConfig, () =>
            OpenSearchServerless.SecurityConfigProvider(),
          ),
          flociDual(OpenSearchServerless.SecurityPolicy, () =>
            OpenSearchServerless.SecurityPolicyProvider(),
          ),
          flociDual(OpenSearchServerless.VpcEndpoint, () =>
            OpenSearchServerless.VpcEndpointProvider(),
          ),
          flociDual(Organizations.Account, () =>
            Organizations.AccountProvider(),
          ),
          flociDual(Organizations.DelegatedAdministrator, () =>
            Organizations.DelegatedAdministratorProvider(),
          ),
          flociDual(Organizations.OrganizationalUnit, () =>
            Organizations.OrganizationalUnitProvider(),
          ),
          flociDual(Organizations.Organization, () =>
            Organizations.OrganizationProvider(),
          ),
          flociDual(Organizations.OrganizationResourcePolicy, () =>
            Organizations.OrganizationResourcePolicyProvider(),
          ),
          flociDual(Organizations.PolicyAttachment, () =>
            Organizations.PolicyAttachmentProvider(),
          ),
          flociDual(Organizations.Policy, () => Organizations.PolicyProvider()),
          flociDual(Organizations.RootPolicyType, () =>
            Organizations.RootPolicyTypeProvider(),
          ),
          flociDual(Organizations.Root, () => Organizations.RootProvider()),
          flociDual(Organizations.TrustedServiceAccess, () =>
            Organizations.TrustedServiceAccessProvider(),
          ),
          flociDual(PaymentCryptography.Alias, () =>
            PaymentCryptography.AliasProvider(),
          ),
          flociDual(PaymentCryptography.Key, () =>
            PaymentCryptography.KeyProvider(),
          ),
          flociDual(Pipes.Pipe, () => Pipes.PipeProvider()),
          flociDual(Polly.Lexicon, () => Polly.LexiconProvider()),
          flociDual(QApps.QApp, () => QApps.QAppProvider()),
          flociDual(QBusiness.Application, () =>
            QBusiness.ApplicationProvider(),
          ),
          flociDual(QBusiness.DataSource, () => QBusiness.DataSourceProvider()),
          flociDual(QBusiness.Index, () => QBusiness.IndexProvider()),
          flociDual(QBusiness.Retriever, () => QBusiness.RetrieverProvider()),
          flociDual(QBusiness.WebExperience, () =>
            QBusiness.WebExperienceProvider(),
          ),
          flociDual(QuickSight.Analysis, () => QuickSight.AnalysisProvider()),
          flociDual(QuickSight.Dashboard, () => QuickSight.DashboardProvider()),
          flociDual(QuickSight.DataSet, () => QuickSight.DataSetProvider()),
          flociDual(QuickSight.DataSource, () =>
          ...
          flociDual(RDS.DBProxyEndpoint, () => RDS.DBProxyEndpointProvider()),
          flociDual(RDS.DBProxy, () => RDS.DBProxyProvider()),
          flociDual(RDS.DBProxyTargetGroup, () =>
            RDS.DBProxyTargetGroupProvider(),
          ),
          flociDual(RDS.DBSubnetGroup, () => RDS.DBSubnetGroupProvider()),
          flociDual(RePostSpace.Space, () => RePostSpace.SpaceProvider()),
          flociDual(Redshift.ClusterParameterGroup, () =>
            Redshift.ClusterParameterGroupProvider(),
          ),
          flociDual(Redshift.Cluster, () => Redshift.ClusterProvider()),
          flociDual(Redshift.ClusterSubnetGroup, () =>
            Redshift.ClusterSubnetGroupProvider(),
          ),
          flociDual(Redshift.EventSubscription, () =>
            Redshift.EventSubscriptionProvider(),
          ),
          flociDual(RedshiftServerless.Namespace, () =>
            RedshiftServerless.NamespaceProvider(),
          ),
          flociDual(RedshiftServerless.Workgroup, () =>
          ...
          flociDual(SNS.PlatformApplication, () =>
          ...
          flociDual(SocialMessaging.LinkedWhatsAppBusinessAccount, () =>
          ...
          flociDual(XRay.Group, () => XRay.GroupProvider()),
          flociDual(XRay.ResourcePolicy, () => XRay.ResourcePolicyProvider()),
          flociDual(XRay.SamplingRule, () => XRay.SamplingRuleProvider()),
          flociDual(Bedrock.Agent, () => Bedrock.AgentProvider()),
          flociDual(Bedrock.AgentAlias, () => Bedrock.AgentAliasProvider()),
          flociDual(Bedrock.DataSource, () => Bedrock.DataSourceProvider()),
          flociDual(Bedrock.KnowledgeBase, () =>
            Bedrock.KnowledgeBaseProvider(),
          ),
          flociDual(BedrockAgentCore.BrowserCustom, () =>
            BedrockAgentCore.BrowserCustomProvider(),
          ),
          flociDual(BedrockAgentCore.CodeInterpreter, () =>
            BedrockAgentCore.CodeInterpreterProvider(),
          ),
          flociDual(BedrockAgentCore.Gateway, () =>
            BedrockAgentCore.GatewayProvider(),
          ),
          flociDual(BedrockAgentCore.Memory, () =>
            BedrockAgentCore.MemoryProvider(),
          ),
          flociDual(BedrockAgentCore.Runtime, () =>
            BedrockAgentCore.RuntimeProvider(),
          ),
          flociDual(AccessAnalyzer.Analyzer, () =>
            AccessAnalyzer.AnalyzerProvider(),
          ),
          flociDual(AccessAnalyzer.ArchiveRule, () =>
            AccessAnalyzer.ArchiveRuleProvider(),
          ),
          flociDual(Textract.Adapter, () => Textract.AdapterProvider()),
          flociDual(Transfer.Server, () => Transfer.ServerProvider()),
          flociDual(Transfer.User, () => Transfer.UserProvider()),
          flociDual(Translate.ParallelData, () =>
            Translate.ParallelDataProvider(),
          ),
          flociDual(Translate.Terminology, () =>
            Translate.TerminologyProvider(),
          ),
          flociDual(VerifiedPermissions.IdentitySource, () =>
            VerifiedPermissions.IdentitySourceProvider(),
          ),
          flociDual(VerifiedPermissions.Policy, () =>
            VerifiedPermissions.PolicyProvider(),
          ),
          flociDual(VerifiedPermissions.PolicyStore, () =>
            VerifiedPermissions.PolicyStoreProvider(),
          ),
          flociDual(VerifiedPermissions.PolicyStoreAlias, () =>
            VerifiedPermissions.PolicyStoreAliasProvider(),
          ),
          flociDual(VerifiedPermissions.PolicyTemplate, () =>
            VerifiedPermissions.PolicyTemplateProvider(),
          ),
          flociDual(VerifiedPermissions.Schema, () =>
            VerifiedPermissions.SchemaProvider(),
          ),
          flociDual(Backup.BackupVault, () => Backup.BackupVaultProvider()),
          flociDual(Backup.BackupPlan, () => Backup.BackupPlanProvider()),
          flociDual(Backup.BackupSelection, () =>
            Backup.BackupSelectionProvider(),
          ),
          flociDual(BackupSearch.SearchJob, () =>
            BackupSearch.SearchJobProvider(),
          ),
          flociDual(BackupSearch.ExportJob, () =>
            BackupSearch.ExportJobProvider(),
          ),
          flociDual(BCMDataExports.Export, () =>
            BCMDataExports.ExportProvider(),
          ),
          flociDual(Budgets.Budget, () => Budgets.BudgetProvider()),
          flociDual(Budgets.BudgetAction, () => Budgets.BudgetActionProvider()),
          flociDual(Chatbot.Association, () => Chatbot.AssociationProvider()),
          flociDual(Chatbot.CustomAction, () => Chatbot.CustomActionProvider()),
          flociDual(Chatbot.MicrosoftTeamsChannelConfiguration, () =>
            Chatbot.MicrosoftTeamsChannelConfigurationProvider(),
          ),
          flociDual(Chatbot.SlackChannelConfiguration, () =>
            Chatbot.SlackChannelConfigurationProvider(),
          ),
          flociDual(GuardDuty.Detector, () => GuardDuty.DetectorProvider()),
          flociDual(GuardDuty.Filter, () => GuardDuty.FilterProvider()),
          flociDual(GuardDuty.IPSet, () => GuardDuty.IPSetProvider()),
          flociDual(GuardDuty.ThreatIntelSet, () =>
            GuardDuty.ThreatIntelSetProvider(),
          ),
          flociDual(ImageBuilder.Component, () =>
            ImageBuilder.ComponentProvider(),
          ),
          flociDual(ImageBuilder.DistributionConfiguration, () =>
            ImageBuilder.DistributionConfigurationProvider(),
          ),
          flociDual(ImageBuilder.ImagePipeline, () =>
            ImageBuilder.ImagePipelineProvider(),
          ),
          flociDual(ImageBuilder.ImageRecipe, () =>
            ImageBuilder.ImageRecipeProvider(),
          ),
          flociDual(ImageBuilder.InfrastructureConfiguration, () =>
          ...
          flociDual(InternetMonitor.Monitor, () =>
            InternetMonitor.MonitorProvider(),
          ),
          flociDual(SecurityHub.ActionTarget, () =>
            SecurityHub.ActionTargetProvider(),
          ),
          flociDual(SecurityHub.AutomationRule, () =>
            SecurityHub.AutomationRuleProvider(),
          ),
          flociDual(SecurityHub.FindingAggregator, () =>
            SecurityHub.FindingAggregatorProvider(),
          ),
          flociDual(SecurityHub.Hub, () => SecurityHub.HubProvider()),
          flociDual(SecurityHub.Insight, () => SecurityHub.InsightProvider()),
          flociDual(SecurityLake.DataLake, () =>
            SecurityLake.DataLakeProvider(),
          ),
          flociDual(SecurityLake.AwsLogSource, () =>
            SecurityLake.AwsLogSourceProvider(),
          ),
          flociDual(SecurityLake.CustomLogSource, () =>
            SecurityLake.CustomLogSourceProvider(),
          ),
          flociDual(SecurityLake.ExceptionSubscription, () =>
            SecurityLake.ExceptionSubscriptionProvider(),
          ),
          flociDual(SecurityLake.Subscriber, () =>
            SecurityLake.SubscriberProvider(),
          ),
          flociDual(SecurityLake.SubscriberNotification, () =>
            SecurityLake.SubscriberNotificationProvider(),
          ),
          flociDual(Detective.Graph, () => Detective.GraphProvider()),
          flociDual(FMS.AdminAccount, () => FMS.AdminAccountProvider()),
          flociDual(Macie2.Session, () => Macie2.SessionProvider()),
          flociDual(Macie2.ClassificationJob, () =>
            Macie2.ClassificationJobProvider(),
          ),
          flociDual(Macie2.AllowList, () => Macie2.AllowListProvider()),
          flociDual(Macie2.CustomDataIdentifier, () =>
            Macie2.CustomDataIdentifierProvider(),
          ),
          flociDual(Macie2.FindingsFilter, () =>
            Macie2.FindingsFilterProvider(),
          ),
          flociDual(RAM.Permission, () => RAM.PermissionProvider()),
          flociDual(RAM.ResourceShare, () => RAM.ResourceShareProvider()),
        ),
        Layer.mergeAll(
          flociDual(AIOps.InvestigationGroup, () =>
            AIOps.InvestigationGroupProvider(),
          ),
          flociDual(AuditManager.Assessment, () =>
            AuditManager.AssessmentProvider(),
          ),
          flociDual(AuditManager.Control, () => AuditManager.ControlProvider()),
          flociDual(AuditManager.Framework, () =>
            AuditManager.FrameworkProvider(),
          ),
          flociDual(ApplicationSignals.Discovery, () =>
            ApplicationSignals.DiscoveryProvider(),
          ),
          flociDual(ApplicationSignals.GroupingConfiguration, () =>
            ApplicationSignals.GroupingConfigurationProvider(),
          ),
          flociDual(ApplicationSignals.InstrumentationConfiguration, () =>
            ApplicationSignals.InstrumentationConfigurationProvider(),
          ),
          flociDual(ApplicationSignals.ServiceLevelObjective, () =>
            ApplicationSignals.ServiceLevelObjectiveProvider(),
          ),
          flociDual(LicenseManager.LicenseConfiguration, () =>
            LicenseManager.LicenseConfigurationProvider(),
          ),
          flociDual(LexV2.Bot, () => LexV2.BotProvider()),
          flociDual(LexV2.BotAlias, () => LexV2.BotAliasProvider()),
          flociDual(LexV2.BotLocale, () => LexV2.BotLocaleProvider()),
          flociDual(LexV2.BotVersion, () => LexV2.BotVersionProvider()),
          flociDual(LexV2.Intent, () => LexV2.IntentProvider()),
          flociDual(LexV2.SlotType, () => LexV2.SlotTypeProvider()),
          flociDual(S3Files.FileSystem, () => S3Files.FileSystemProvider()),
          flociDual(S3Files.AccessPoint, () => S3Files.AccessPointProvider()),
          flociDual(S3Tables.TableBucket, () => S3Tables.TableBucketProvider()),
          flociDual(S3Tables.Namespace, () => S3Tables.NamespaceProvider()),
          flociDual(S3Tables.Table, () => S3Tables.TableProvider()),
          flociDual(S3Vectors.VectorBucket, () =>
            S3Vectors.VectorBucketProvider(),
          ),
          flociDual(S3Vectors.Index, () => S3Vectors.IndexProvider()),
          flociDual(SageMaker.Model, () => SageMaker.ModelProvider()),
          flociDual(SageMaker.EndpointConfig, () =>
            SageMaker.EndpointConfigProvider(),
          ),
          flociDual(SageMaker.Endpoint, () => SageMaker.EndpointProvider()),
          ...
          flociDual(Account.ContactInformation, () =>
            Account.ContactInformationProvider(),
          ),
          flociDual(Account.Region, () => Account.RegionProvider()),
          flociDual(Amplify.App, () => Amplify.AppProvider()),
          flociDual(Amplify.Branch, () => Amplify.BranchProvider()),
          flociDual(ECRPublic.PublicRepository, () =>
            ECRPublic.PublicRepositoryProvider(),
          ),
          flociDual(VpcLattice.ServiceNetwork, () =>
            VpcLattice.ServiceNetworkProvider(),
          ),
          flociDual(VpcLattice.Service, () => VpcLattice.ServiceProvider()),
          flociDual(VpcLattice.ServiceNetworkVpcAssociation, () =>
            VpcLattice.ServiceNetworkVpcAssociationProvider(),
          ),
          flociDual(VpcLattice.AuthPolicy, () =>
            VpcLattice.AuthPolicyProvider(),
          ),
          flociDual(VpcLattice.ResourcePolicy, () =>
            VpcLattice.ResourcePolicyProvider(),
          ),
          flociDual(VpcLattice.ServiceNetworkServiceAssociation, () =>
            VpcLattice.ServiceNetworkServiceAssociationProvider(),
          ),
          flociDual(VpcLattice.TargetGroup, () =>
            VpcLattice.TargetGroupProvider(),
          ),
          flociDual(VpcLattice.Listener, () => VpcLattice.ListenerProvider()),
          flociDual(VpcLattice.Rule, () => VpcLattice.RuleProvider()),
          flociDual(VpcLattice.AccessLogSubscription, () =>
            VpcLattice.AccessLogSubscriptionProvider(),
          ),
          flociDual(MWAA.Environment, () => MWAA.EnvironmentProvider()),
          flociDual(MWAAServerless.Workflow, () =>
            MWAAServerless.WorkflowProvider(),
          ),
          flociDual(Location.ApiKey, () => Location.ApiKeyProvider()),
          flociDual(Location.Map, () => Location.MapProvider()),
          flociDual(Location.PlaceIndex, () => Location.PlaceIndexProvider()),
          flociDual(Location.RouteCalculator, () =>
            Location.RouteCalculatorProvider(),
          ),
          flociDual(Location.GeofenceCollection, () =>
            Location.GeofenceCollectionProvider(),
          ),
          flociDual(Location.Tracker, () => Location.TrackerProvider()),
          flociDual(Location.TrackerConsumer, () =>
            Location.TrackerConsumerProvider(),
          ),
          flociDual(Forecast.DatasetGroup, () =>
            Forecast.DatasetGroupProvider(),
          ),
          flociDual(Forecast.Dataset, () => Forecast.DatasetProvider()),
          flociDual(FraudDetector.Detector, () =>
            FraudDetector.DetectorProvider(),
          ),
          flociDual(FraudDetector.DetectorVersion, () =>
            FraudDetector.DetectorVersionProvider(),
          ),
          flociDual(FraudDetector.EntityType, () =>
            FraudDetector.EntityTypeProvider(),
          ),
          flociDual(FraudDetector.EventType, () =>
            FraudDetector.EventTypeProvider(),
          ),
          flociDual(FraudDetector.Label, () => FraudDetector.LabelProvider()),
          flociDual(FraudDetector.List, () => FraudDetector.ListProvider()),
          flociDual(FraudDetector.Outcome, () =>
            FraudDetector.OutcomeProvider(),
          ),
          flociDual(FraudDetector.Variable, () =>
            FraudDetector.VariableProvider(),
          ),
          flociDual(Personalize.Schema, () => Personalize.SchemaProvider()),
          flociDual(Personalize.DatasetGroup, () =>
            Personalize.DatasetGroupProvider(),
          ),
          flociDual(Personalize.Dataset, () => Personalize.DatasetProvider()),
          flociDual(Personalize.EventTracker, () =>
            Personalize.EventTrackerProvider(),
          ),
          flociDual(PinpointSMSVoiceV2.ConfigurationSet, () =>
            PinpointSMSVoiceV2.ConfigurationSetProvider(),
          ),
          flociDual(PinpointSMSVoiceV2.EventDestination, () =>
            PinpointSMSVoiceV2.EventDestinationProvider(),
          ),
          flociDual(PinpointSMSVoiceV2.OptOutList, () =>
            PinpointSMSVoiceV2.OptOutListProvider(),
          ),
          flociDual(PinpointSMSVoiceV2.PhoneNumber, () =>
            PinpointSMSVoiceV2.PhoneNumberProvider(),
          ),
          flociDual(IoT.Thing, () => IoT.ThingProvider()),
          flociDual(IoT.ThingType, () => IoT.ThingTypeProvider()),
          flociDual(IoT.Policy, () => IoT.PolicyProvider()),
          flociDual(IoT.TopicRule, () => IoT.TopicRuleProvider()),
          flociDual(IoTFleetWise.Campaign, () =>
            IoTFleetWise.CampaignProvider(),
          ),
          flociDual(IoTFleetWise.DecoderManifest, () =>
            IoTFleetWise.DecoderManifestProvider(),
          ),
          flociDual(IoTFleetWise.Fleet, () => IoTFleetWise.FleetProvider()),
          flociDual(IoTFleetWise.ModelManifest, () =>
            IoTFleetWise.ModelManifestProvider(),
          ),
          flociDual(IoTFleetWise.SignalCatalog, () =>
            IoTFleetWise.SignalCatalogProvider(),
          ),
          flociDual(IoTFleetWise.StateTemplate, () =>
            IoTFleetWise.StateTemplateProvider(),
          ),
          flociDual(IoTFleetWise.Vehicle, () => IoTFleetWise.VehicleProvider()),
          flociDual(IoTManagedIntegrations.CredentialLocker, () =>
            IoTManagedIntegrations.CredentialLockerProvider(),
          ),
          flociDual(IoTManagedIntegrations.Destination, () =>
            IoTManagedIntegrations.DestinationProvider(),
          ),
          flociDual(IoTManagedIntegrations.ManagedThing, () =>
            IoTManagedIntegrations.ManagedThingProvider(),
          ),
          flociDual(IoTManagedIntegrations.NotificationConfiguration, () =>
            IoTManagedIntegrations.NotificationConfigurationProvider(),
          ),
          flociDual(IoTSiteWise.AssetModel, () =>
            IoTSiteWise.AssetModelProvider(),
          ),
          flociDual(IoTSiteWise.Asset, () => IoTSiteWise.AssetProvider()),
          flociDual(IoTSiteWise.Gateway, () => IoTSiteWise.GatewayProvider()),
          flociDual(IoTWireless.Destination, () =>
            IoTWireless.DestinationProvider(),
          ),
          flociDual(IoTWireless.DeviceProfile, () =>
            IoTWireless.DeviceProfileProvider(),
          ),
          flociDual(IoTWireless.ServiceProfile, () =>
            IoTWireless.ServiceProfileProvider(),
          ),
          flociDual(IoTWireless.WirelessDevice, () =>
            IoTWireless.WirelessDeviceProvider(),
          ),
          flociDual(IoTWireless.WirelessGateway, () =>
            IoTWireless.WirelessGatewayProvider(),
          ),
          flociDual(ResourceGroups.Group, () => ResourceGroups.GroupProvider()),
          flociDual(RolesAnywhere.Crl, () => RolesAnywhere.CrlProvider()),
          flociDual(RolesAnywhere.Profile, () =>
            RolesAnywhere.ProfileProvider(),
          ),
          flociDual(RolesAnywhere.TrustAnchor, () =>
            RolesAnywhere.TrustAnchorProvider(),
          ),
          flociDual(Synthetics.Canary, () => Synthetics.CanaryProvider()),
          flociDual(Synthetics.Group, () => Synthetics.GroupProvider()),
          flociDual(SSMContacts.Contact, () => SSMContacts.ContactProvider()),
          flociDual(SSMContacts.ContactChannel, () =>
            SSMContacts.ContactChannelProvider(),
          ),
          flociDual(SSMContacts.Plan, () => SSMContacts.PlanProvider()),
          flociDual(SSMContacts.Rotation, () => SSMContacts.RotationProvider()),
          flociDual(SSMIncidents.ReplicationSet, () =>
            SSMIncidents.ReplicationSetProvider(),
          ),
          flociDual(SSMIncidents.ResponsePlan, () =>
            SSMIncidents.ResponsePlanProvider(),
          ),
        ),
        Layer.mergeAll(
          flociDual(FinSpace.Environment, () => FinSpace.EnvironmentProvider()),
          flociDual(FinSpace.KxCluster, () => FinSpace.KxClusterProvider()),
          flociDual(FinSpace.KxDatabase, () => FinSpace.KxDatabaseProvider()),
          flociDual(FinSpace.KxEnvironment, () =>
            FinSpace.KxEnvironmentProvider(),
          ),
          flociDual(ControlTower.EnabledBaseline, () =>
            ControlTower.EnabledBaselineProvider(),
          ),
          flociDual(ControlTower.EnabledControl, () =>
            ControlTower.EnabledControlProvider(),
          ),
          flociDual(ControlTower.LandingZone, () =>
            ControlTower.LandingZoneProvider(),
          ),
          flociDual(CostAndUsageReport.ReportDefinition, () =>
            CostAndUsageReport.ReportDefinitionProvider(),
          ),
          flociDual(CostExplorer.AnomalyMonitor, () =>
            CostExplorer.AnomalyMonitorProvider(),
          ),
          flociDual(CostExplorer.AnomalySubscription, () =>
            CostExplorer.AnomalySubscriptionProvider(),
          ),
          flociDual(CostExplorer.CostCategory, () =>
            CostExplorer.CostCategoryProvider(),
          ),
          flociDual(Rbin.Rule, () => Rbin.RuleProvider()),
          flociDual(RUM.AppMonitor, () => RUM.AppMonitorProvider()),
          flociDual(RUM.MetricsDestination, () =>
            RUM.MetricsDestinationProvider(),
          ),
          flociDual(RUM.ResourcePolicy, () => RUM.ResourcePolicyProvider()),
          flociDual(EMR.Cluster, () => EMR.ClusterProvider()),
          flociDual(EMR.SecurityConfiguration, () =>
            EMR.SecurityConfigurationProvider(),
          ),
          flociDual(EMR.Studio, () => EMR.StudioProvider()),
          flociDual(EMRContainers.JobTemplate, () =>
            EMRContainers.JobTemplateProvider(),
          ),
          flociDual(EMRContainers.VirtualCluster, () =>
            EMRContainers.VirtualClusterProvider(),
          ),
          flociDual(EMRServerless.Application, () =>
            EMRServerless.ApplicationProvider(),
          ),
          flociDual(EntityResolution.SchemaMapping, () =>
            EntityResolution.SchemaMappingProvider(),
          ),
          flociDual(EntityResolution.MatchingWorkflow, () =>
            EntityResolution.MatchingWorkflowProvider(),
          ),
          flociDual(EntityResolution.IdNamespace, () =>
            EntityResolution.IdNamespaceProvider(),
          ),
          flociDual(EntityResolution.IdMappingWorkflow, () =>
            EntityResolution.IdMappingWorkflowProvider(),
          ),
          flociDual(Schemas.Discoverer, () => Schemas.DiscovererProvider()),
          flociDual(Schemas.Registry, () => Schemas.RegistryProvider()),
          flociDual(Schemas.Schema, () => Schemas.SchemaProvider()),
          flociDual(Route53Profiles.Profile, () =>
            Route53Profiles.ProfileProvider(),
          ),
          flociDual(Route53Profiles.ProfileAssociation, () =>
            Route53Profiles.ProfileAssociationProvider(),
          ),
          flociDual(Route53Profiles.ProfileResourceAssociation, () =>
            Route53Profiles.ProfileResourceAssociationProvider(),
          ),
          flociDual(Route53Resolver.ResolverEndpoint, () =>
            Route53Resolver.ResolverEndpointProvider(),
          ),
          flociDual(Route53Resolver.ResolverRule, () =>
            Route53Resolver.ResolverRuleProvider(),
          ),
          flociDual(Route53Resolver.ResolverRuleAssociation, () =>
            Route53Resolver.ResolverRuleAssociationProvider(),
          ),
          flociDual(Shield.Protection, () => Shield.ProtectionProvider()),
          flociDual(Shield.ProtectionGroup, () =>
            Shield.ProtectionGroupProvider(),
          ),
          flociDual(Shield.Subscription, () => Shield.SubscriptionProvider()),
          flociDual(Signer.ProfilePermission, () =>
            Signer.ProfilePermissionProvider(),
          ),
          flociDual(Signer.SigningProfile, () =>
            Signer.SigningProfileProvider(),
          ),
          flociDual(SimpleDB.Domain, () => SimpleDB.DomainProvider()),
          flociDual(Timestream.Database, () => Timestream.DatabaseProvider()),
          flociDual(Timestream.DbInstance, () =>
            Timestream.DbInstanceProvider(),
          ),
          flociDual(Timestream.ScheduledQuery, () =>
            Timestream.ScheduledQueryProvider(),
          ),
          flociDual(Timestream.Table, () => Timestream.TableProvider()),
          flociDual(ResourceExplorer.Index, () =>
            ResourceExplorer.IndexProvider(),
          ),
          flociDual(ResourceExplorer.View, () =>
            ResourceExplorer.ViewProvider(),
          ),
          flociDual(Notifications.ChannelAssociation, () =>
            Notifications.ChannelAssociationProvider(),
          ),
          flociDual(Notifications.EventRule, () =>
            Notifications.EventRuleProvider(),
          ),
          flociDual(Notifications.NotificationConfiguration, () =>
            Notifications.NotificationConfigurationProvider(),
          ),
          flociDual(Notifications.NotificationHub, () =>
            Notifications.NotificationHubProvider(),
          ),
          flociDual(NotificationsContacts.EmailContact, () =>
            NotificationsContacts.EmailContactProvider(),
          ),
          flociDual(OAM.Link, () => OAM.LinkProvider()),
          flociDual(OAM.Sink, () => OAM.SinkProvider()),
          flociDual(ObservabilityAdmin.TelemetryConfig, () =>
            ObservabilityAdmin.TelemetryConfigProvider(),
          ),
          flociDual(ObservabilityAdmin.TelemetryRule, () =>
            ObservabilityAdmin.TelemetryRuleProvider(),
          ),
          flociDual(Omics.AnnotationStore, () =>
            Omics.AnnotationStoreProvider(),
          ),
          flociDual(Omics.ReferenceStore, () => Omics.ReferenceStoreProvider()),
          flociDual(Omics.RunGroup, () => Omics.RunGroupProvider()),
          flociDual(Omics.SequenceStore, () => Omics.SequenceStoreProvider()),
          flociDual(Omics.VariantStore, () => Omics.VariantStoreProvider()),
          flociDual(Omics.Workflow, () => Omics.WorkflowProvider()),
          flociDual(GlobalAccelerator.Accelerator, () =>
            GlobalAccelerator.AcceleratorProvider(),
          ),
          flociDual(GlobalAccelerator.Listener, () =>
            GlobalAccelerator.ListenerProvider(),
          ),
          flociDual(GlobalAccelerator.EndpointGroup, () =>
            GlobalAccelerator.EndpointGroupProvider(),
          ),
          flociDual(AppRegistry.Application, () =>
            AppRegistry.ApplicationProvider(),
          ),
          flociDual(AppRegistry.AttributeGroup, () =>
            AppRegistry.AttributeGroupProvider(),
          ),
          flociDual(AppRegistry.AttributeGroupAssociation, () =>
            AppRegistry.AttributeGroupAssociationProvider(),
          ),
          flociDual(AppRegistry.ResourceAssociation, () =>
            AppRegistry.ResourceAssociationProvider(),
          ),
          flociDual(ServiceCatalog.Portfolio, () =>
            ServiceCatalog.PortfolioProvider(),
          ),
          flociDual(ServiceCatalog.PortfolioProductAssociation, () =>
            ServiceCatalog.PortfolioProductAssociationProvider(),
          ),
          flociDual(ServiceCatalog.PrincipalPortfolioAssociation, () =>
            ServiceCatalog.PrincipalPortfolioAssociationProvider(),
          ),
          flociDual(ServiceCatalog.Product, () =>
            ServiceCatalog.ProductProvider(),
          ),
          flociDual(ServiceQuotas.ServiceQuotaIncreaseRequest, () =>
            ServiceQuotas.ServiceQuotaIncreaseRequestProvider(),
          ),
          flociDual(S3Control.AccessPoint, () =>
            S3Control.AccessPointProvider(),
          ),
          flociDual(S3Control.AccessPointPolicy, () =>
            S3Control.AccessPointPolicyProvider(),
          ),
          flociDual(S3Control.MultiRegionAccessPoint, () =>
            S3Control.MultiRegionAccessPointProvider(),
          ),
          flociDual(S3Control.ObjectLambdaAccessPoint, () =>
            S3Control.ObjectLambdaAccessPointProvider(),
          ),
          flociDual(S3Control.StorageLensConfiguration, () =>
            S3Control.StorageLensConfigurationProvider(),
          ),
          flociDual(NetworkFirewall.RuleGroup, () =>
            NetworkFirewall.RuleGroupProvider(),
          ),
          flociDual(NetworkFirewall.FirewallPolicy, () =>
            NetworkFirewall.FirewallPolicyProvider(),
          ),
          flociDual(NetworkFirewall.Firewall, () =>
            NetworkFirewall.FirewallProvider(),
          ),
          flociDual(NetworkFirewall.LoggingConfiguration, () =>
            NetworkFirewall.LoggingConfigurationProvider(),
          ),
          flociDual(CloudTrail.EventDataStore, () =>
            CloudTrail.EventDataStoreProvider(),
          ),
          flociDual(CloudTrail.Trail, () => CloudTrail.TrailProvider()),
          flociDual(IVS.Channel, () => IVS.ChannelProvider()),
          flociDual(IVS.PlaybackKeyPair, () => IVS.PlaybackKeyPairProvider()),
          flociDual(IVS.PlaybackRestrictionPolicy, () =>
            IVS.PlaybackRestrictionPolicyProvider(),
          ),
          flociDual(IVS.RecordingConfiguration, () =>
            IVS.RecordingConfigurationProvider(),
          ),
          flociDual(IVS.StreamKey, () => IVS.StreamKeyProvider()),
          flociDual(IVSChat.LoggingConfiguration, () =>
            IVSChat.LoggingConfigurationProvider(),
          ),
          flociDual(IVSChat.Room, () => IVSChat.RoomProvider()),
          flociDual(IVSRealtime.Stage, () => IVSRealtime.StageProvider()),
        ),
      ),
    ),
