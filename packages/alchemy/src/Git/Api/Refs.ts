...
export const ListRefs = HttpApiEndpoint.get("list", "/repos/:owner/:repo/refs", {
  params: RepoPath,
  query: Schema.Struct({
...
export const UpdateRef = HttpApiEndpoint.put("update", "/repos/:owner/:repo/ref", {
  params: RepoPath,
  query: Schema.Struct({ name: RefName }),
...
export const RemoveRef = HttpApiEndpoint.delete("remove", "/repos/:owner/:repo/ref", {
  params: RepoPath,
  query: Schema.Struct({ name: RefName }),
  payload: Schema.Struct({
