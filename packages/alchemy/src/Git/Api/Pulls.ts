 ...
 */
export const CreatePull = HttpApiEndpoint.post("create", "/repos/:owner/:repo/pulls", {
  params: RepoPath,
...
export const ListPulls = HttpApiEndpoint.get("list", "/repos/:owner/:repo/pulls", {
  params: RepoPath,
  query: Schema.Struct({
...
export const GetPull = HttpApiEndpoint.get("get", "/repos/:owner/:repo/pulls/:number", {
  params: PullPath,
  success: PullDetail,
...
export const UpdatePull = HttpApiEndpoint.patch("update", "/repos/:owner/:repo/pulls/:number", {
  params: PullPath,
  payload: Schema.Struct({
 ...
 */
export const MergePull = HttpApiEndpoint.post("merge", "/repos/:owner/:repo/pulls/:number/merge", {
  params: PullPath,
  payload: Schema.Struct({
    /**
