...
export type SignedNodesDeploymentsDevice = Resource<
  "GCP.ProdTtSasportal.SignedNodesDeploymentsDevice",
...
/**
 * A CPI-signed CBSD under a SAS Portal node deployment in the production-test (prod-tt) environment.
 *
 ...
 * ```typescript
 * const device = yield* GCP.ProdTtSasportal.SignedNodesDeploymentsDevice("Cbsd", {
...
export class SignedNodesDeploymentsDeviceNotResolved extends Data.TaggedError(
  "GCP.ProdTtSasportal.SignedNodesDeploymentsDeviceNotResolved",
)<{
  name: string;
}> {}
