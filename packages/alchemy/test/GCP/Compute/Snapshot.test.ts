...
test.provider.skipIf(!hasGcpCreds || !!process.env.FAST)(
  "create, update, and delete a snapshot",
  (stack) =>
    Effect.gen(function* () {
      yield* stack.destroy();
      ...
      const created = yield* stack.deploy(
        Effect.gen(function* () {
          ...
          const snapshot = yield* GCP.Compute.Snapshot("Backup", {
      ...
      const fetched = yield* compute.getSnapshots({
      ...
      const fetchedUpdated = yield* compute.getSnapshots({
