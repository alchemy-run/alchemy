...
describe.sequential("App deletion", () => {
  const { test } = Test.make({ providers: Fly.providers() });
...
describe.sequential("App deletion verification", () => {
  const { test } = Test.make({ providers: Fly.providers() });
...
describe.sequential("commit recovery", () => {
...
describe.sequential("create faults", () => {
...
describe.sequential("engine state", () => {
  const file = "test/Fly/BlueGreen.test.ts";
...
describe.sequential("health transport faults", () => {
  let endpoint: string | undefined;
  const { test } = Test.make({ providers: throughProxy(() => endpoint) });
...
describe.sequential("health deadlines", () => {
  const { test } = Test.make({ providers: Fly.providers() });
...
describe.sequential("idle capacity", () => {
  let endpoint: string | undefined;
  const { test } = Test.make({ providers: throughProxy(() => endpoint) });
...
describe.sequential("image identity", () => {
  const { test } = Test.make({ providers: Fly.providers() });
...
describe.sequential("fiber interruption", () => {
  const file = "test/Fly/BlueGreen.test.ts";
  const { test } = Test.make({ providers: Fly.providers() });
...
describe.sequential("native leases", () => {
  const { test } = Test.make({ providers: Fly.providers() });
...
describe.sequential("legacy compatibility", () => {
  const file = "test/Fly/BlueGreen.test.ts";
  let endpoint: string | undefined;
...
describe.sequential("check cadence", () => {
  const file = "test/Fly/BlueGreen.test.ts";
  const { test } = Test.make({ providers: Fly.providers() });
...
describe.sequential("process death", () => {
  const options = {
...
describe.sequential("promotion faults", () => {
  let endpoint: string | undefined;
  const { test } = Test.make({ providers: throughProxy(() => endpoint) });
...
describe.sequential("protocol branches", () => {
  it.live(
...
describe.sequential("required metadata writes", () => {
  let endpoint: string | undefined;
  const { test } = Test.make({ providers: throughProxy(() => endpoint) });
...
describe.sequential("retirement residuals", () => {
  let endpoint: string | undefined;
  const { test } = Test.make({ providers: throughProxy(() => endpoint) });
  const props = {
    count: 2,
...
describe.sequential("runtime secrets", () => {
  const { test } = Test.make({ providers: Fly.providers() });
...
describe.sequential("managed HTTP services", () => {
  const { test } = Test.make({ providers: Fly.providers() });
...
describe.sequential("process signals and overlap", () => {
  const options = {
    providers: Fly.providers(),
    profile: "testing",
    dev: false,
