...
describe(
  ...
  () => {
    ...
    test("data-residency ghe.com hosts get the api. prefix", () => {
      ...
      expect(normalize("https://acme.ghe.com")).toBe(
...
describe(
  ...
  () => {
    ...
    test("making the ambient enterprise host explicit is not a change", () => {
      ...
      expect(
        changed(undefined, "github.example.com", "github.example.com"),
      ).toBe(false);
      expect(
        changed("github.example.com", undefined, "github.example.com"),
      ).toBe(false);
      expect(
        changed(
          undefined,
