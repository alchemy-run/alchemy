...
describe("detectLayout", (it) => {
  it.effect(
    "classifies drizzle-kit v1 dirs as directory layout",
    () =>
      Effect.gen(function* () {
  ...
  it.effect(
    "classifies Prisma dirs as directory layout too",
    () =>
  ...
  it.effect(
    "classifies flat .sql directories",
    () =>
      Effect.gen(function* () {
  ...
  it.effect(
    "treats a missing directory as flat",
    () =>
      Effect.gen(function* () {
...
describe("readers", (it) => {
  it.effect(
    "directory-layout records are keyed by directory name",
    () =>
      Effect.gen(function* () {
  ...
  it.effect(
    "flat records are keyed by relative file path",
    () =>
      Effect.gen(function* () {
...
plainDescribe("resolveMigrations", { tags: ["local"] }, () => {
  test(
  ...
  test(
    "a table persisted by a prior deploy wins over the default",
    () => {
...
plainDescribe("normalizeMigrationsInput", { tags: ["local"] }, () => {
  test(
...
plainDescribe("helpers", { tags: ["local"] }, () => {
  test(
