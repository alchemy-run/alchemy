  ...
  (stack) =>
    Effect.gen(function* () {
      ...
      const watermark = yield* stack.deploy(
        Cloudflare.Stream.StreamWatermark("DefaultWatermark", {
          url: PNG_URL,
        }),
      );
  ...
  (stack) =>
    Effect.gen(function* () {
      ...
      const initial = yield* stack.deploy(
        Cloudflare.Stream.StreamWatermark("ReplaceWatermark", {
  ...
  (stack) =>
    Effect.gen(function* () {
      ...
      const deployed = yield* stack.deploy(
        Cloudflare.Stream.StreamWatermark("ListWatermark", {
      ...
      const provider = yield* Provider.findProvider(
        Cloudflare.Stream.StreamWatermark,
      );
