import type { WriteKVNamespaceClient } from "@/Cloudflare/KV/NamespaceWrite.ts";
 ...
 * every method of {@link WriteKVNamespaceClient} is driven over `fetch`:
 *
