...
export type WidgetModel =
  runtime.Types.Result.DefaultSelection<Prisma.$WidgetPayload>;
...
> = {
   ...
   */
  orderBy?:
    | Prisma.WidgetOrderByWithRelationInput
    | Prisma.WidgetOrderByWithRelationInput[];
  /**
...
> = {
  where?: Prisma.WidgetWhereInput;
  orderBy?:
    | Prisma.WidgetOrderByWithAggregationInput
    | Prisma.WidgetOrderByWithAggregationInput[];
...
export type GetWidgetGroupByPayload<T extends WidgetGroupByArgs> =
...
export type WidgetGetPayload<
  S extends boolean | null | undefined | WidgetDefaultArgs,
...
> {
  ...
  >(
    args: Prisma.SubsetIntersection<T, WidgetGroupByArgs, OrderByArg> &
      InputErrors,
  ): {} extends InputErrors
    ? GetWidgetGroupByPayload<T>
...
> = {
  ...
  data: Prisma.XOR<
    ...
    Prisma.WidgetUncheckedUpdateManyInput
  >;
  /**
