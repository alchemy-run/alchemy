 ...
 * `_redirects` file, because `buildAssetConfigs` passed `logger: undefined!`
 * into constructors that call `logger.log` unconditionally. After the
 * crash every subsequent request hung.
 *
