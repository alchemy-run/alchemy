...
const expectGone = (accountId: string, networkId: string) =>
  getNetwork(accountId, networkId).pipe(
    Effect.flatMap((n) =>
      ...
      n.networkId == null ? Effect.void : Effect.fail({ _tag: "NetworkNotDeleted" } as const),
    ),
...
const SHA_A = "b5bb9d8014a0f9b1d61e21e796d78dccdf1352f23cd32812f4850b878ae4944c" as const;
const SHA_B = "7d865e959b2466918c9863afca942d0fb89d7c9ac0c99bafc3749504ded97730" as const;

test.provider("create, update in place, and delete a managed network", (stack) =>
  Effect.gen(function* () {
...
test.provider("list enumerates the deployed managed network", (stack) =>
  Effect.gen(function* () {
    ...
    const provider = yield* Provider.findProvider(Cloudflare.Devices.DeviceManagedNetwork);
