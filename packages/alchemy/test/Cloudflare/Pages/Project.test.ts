...
test.provider("create and delete a project with generated name", (stack) =>
  Effect.gen(function* () {
    ...
    const project = yield* stack.deploy(
      Cloudflare.Pages.PagesProject("DefaultProject", {}),
    );
...
test.provider("update mutable props in place (same project id)", (stack) =>
  Effect.gen(function* () {
    ...
    const initial = yield* stack.deploy(
      Effect.gen(function* () {
        return yield* Cloudflare.Pages.PagesProject("UpdateProject", {
          name: NAME_UPDATE,
...
test.provider("list enumerates the deployed project", (stack) =>
  Effect.gen(function* () {
    ...
    const deployed = yield* stack.deploy(
      Effect.gen(function* () {
        return yield* Cloudflare.Pages.PagesProject("ListProject", {
          name: NAME_LIST,
        }).pipe(adopt(true));
      }),
    );
...
test.provider("changing the name triggers replacement", (stack) =>
  Effect.gen(function* () {
    ...
    const initial = yield* stack.deploy(
      Effect.gen(function* () {
        return yield* Cloudflare.Pages.PagesProject("ReplaceProject", {
          name: NAME_REPLACE_A,
        }).pipe(adopt(true));
      }),
    );
