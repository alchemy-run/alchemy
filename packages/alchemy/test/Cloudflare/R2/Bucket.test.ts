...
test.provider("create and delete bucket with default props", (stack) =>
  Effect.gen(function* () {
    ...
    const bucket = yield* stack.deploy(
      Effect.gen(function* () {
        return yield* Cloudflare.R2.R2Bucket("DefaultBucket");
      }),
    );
...
test.provider("create, update, delete bucket", (stack) =>
  Effect.gen(function* () {
    ...
    const bucket = yield* stack.deploy(
      Effect.gen(function* () {
        return yield* Cloudflare.R2.R2Bucket("TestBucket", {
  ...
  (stack) =>
    Effect.gen(function* () {
      ...
      const initial = yield* stack.deploy(
        Effect.gen(function* () {
          return yield* Cloudflare.R2.R2Bucket("AdoptableBucket", {
            name: bucketName,
          });
        }),
      );
...
test.provider("destroying a bucket empties its objects first", (stack) =>
  Effect.gen(function* () {
    ...
    const bucket = yield* stack.deploy(
      Effect.gen(function* () {
        return yield* Cloudflare.R2.R2Bucket("BucketWithObjects");
      }),
    );
...
test.provider("lifecycle rules are added, updated, and removed", (stack) =>
  Effect.gen(function* () {
    ...
    const initial = yield* stack.deploy(
      Effect.gen(function* () {
        return yield* Cloudflare.R2.R2Bucket("LifecycleBucket", {
          lifecycleRules: [
            {
              id: "expire-after-30d",
