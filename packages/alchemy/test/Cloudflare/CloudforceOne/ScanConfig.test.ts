  ...
  (stack) =>
    Effect.gen(function* () {
      ...
      const created = yield* stack.deploy(
        Cloudflare.CloudforceOne.CloudforceOneScanConfig("TestScanConfig", {
          ips: ["1.1.1.1/32"],
          frequency: 0,
        }),
      );
...
test.provider("list returns an array of scan configs", (stack) =>
  Effect.gen(function* () {
    ...
    const provider = yield* Provider.findProvider(
      Cloudflare.CloudforceOne.CloudforceOneScanConfig,
    );
  ...
  (stack) =>
    Effect.gen(function* () {
      ...
      const deployed = yield* stack.deploy(
        Cloudflare.CloudforceOne.CloudforceOneScanConfig("ListScanConfig", {
          ips: ["1.1.1.1/32"],
          frequency: 0,
        }),
      );
