  ...
  (stack) =>
    Effect.gen(function* () {
      ...
      const created = yield* stack.deploy(
        Cloudflare.Images.ImagesVariant("alchemytestvariant", {
          fit: "cover",
          width: 100,
          height: 100,
        }).pipe(adopt(true)),
  ...
  (stack) =>
    Effect.gen(function* () {
      ...
      const initial = yield* stack.deploy(
        Cloudflare.Images.ImagesVariant("ReplaceVariant", {
  ...
  (stack) =>
    Effect.gen(function* () {
      ...
      const deployed = yield* stack.deploy(
        Cloudflare.Images.ImagesVariant("alchemytestlistvariant", {
          fit: "cover",
          width: 120,
          height: 120,
        }).pipe(adopt(true)),
      ...
      const provider = yield* Provider.findProvider(
        Cloudflare.Images.ImagesVariant,
      );
