...
import NeptuneBindingsTestFunctionLive, { NeptuneBindingsTestFunction } from "./fixtures/handler";
...
describe.sequential("Neptune Bindings", () => {
  beforeAll(
    Effect.gen(function* () {
      yield* Effect.logInfo("Neptune test setup: destroying previous resources");
