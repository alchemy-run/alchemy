...
class DefaultSubnetNotVisible extends Data.TaggedError("DefaultSubnetNotVisible")<{}> {}
 ...
 */
export const getAutoScalingTestSubnetId: Effect.Effect<`subnet-${string}`, any, any> = Effect.gen(
  function* () {
