...
test.provider.skipIf(!!process.env.FAST)("patch API Gateway account settings", (stack) =>
  Effect.gen(function* () {
...
test.provider.skipIf(!!process.env.FAST)("list returns the account settings singleton", (stack) =>
  Effect.gen(function* () {
