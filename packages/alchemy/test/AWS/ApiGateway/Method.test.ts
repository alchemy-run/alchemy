...
test.provider.skipIf(!!process.env.FAST)("create and delete MOCK method", (stack) =>
  Effect.gen(function* () {
    yield* stack.destroy();
...
test.provider.skipIf(!!process.env.FAST)("list enumerates the deployed method", (stack) =>
  Effect.gen(function* () {
    yield* stack.destroy();
