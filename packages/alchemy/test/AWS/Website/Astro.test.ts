  ...
  test.provider(
    ...
    (stack) =>
      Effect.gen(function* () {
        ...
        yield* expectUrlContains(`${deployed.site.serverUrl!}`, "ASTRO_AWS_PAGE_MARKER", {
          timeout: "120 seconds",
        ...
        yield* expectUrlContains(`${url}/robots.txt`, "astro-aws-robots-marker", {
        ...
        yield* expectUrlContains(`${url}/prerendered/`, "ASTRO_AWS_PRERENDERED_MARKER", {
