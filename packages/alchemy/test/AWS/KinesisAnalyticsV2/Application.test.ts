...
describe.skipIf(!!process.env.FAST)("AWS.KinesisAnalyticsV2.Application", () => {
  test.provider(
    ...
    (stack) =>
      Effect.gen(function* () {
        ...
        const updatedConfig = updatedDescribe.ApplicationDetail.ApplicationConfigurationDescription;
        expect(
