...
export const KinesisApiFunctionLive = KinesisApiFunction.make(
  ...
  Effect.gen(function* () {
    ...
    Effect.provide(
      Layer.provideMerge(
        Layer.mergeAll(
          AWS.Kinesis.StreamSinkBinding,
          AWS.Kinesis.PutRecordsBinding,
        ),
        Layer.mergeAll(
          AWS.Kinesis.DescribeAccountSettingsBinding,
          AWS.Kinesis.DescribeLimitsBinding,
          AWS.Kinesis.DescribeStreamBinding,
          AWS.Kinesis.DescribeStreamConsumerBinding,
          AWS.Kinesis.DescribeStreamSummaryBinding,
          AWS.Kinesis.GetRecordsBinding,
          AWS.Kinesis.GetResourcePolicyBinding,
          AWS.Kinesis.GetShardIteratorBinding,
          AWS.Kinesis.ListShardsBinding,
          AWS.Kinesis.ListStreamConsumersBinding,
          AWS.Kinesis.ListStreamsBinding,
          AWS.Kinesis.ListTagsForResourceBinding,
          AWS.Kinesis.PutRecordBinding,
          AWS.Kinesis.PutRecordsBinding,
          AWS.Kinesis.SubscribeToShardBinding,
