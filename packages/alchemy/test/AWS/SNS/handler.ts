    ...
    Effect.provide(
      Layer.provideMerge(
        Layer.mergeAll(
          ...
          AWS.SNS.TopicSinkBinding,
          AWS.SQS.QueueSinkBinding,
        ),
        Layer.mergeAll(
          AWS.SNS.AddPermissionBinding,
          AWS.SNS.ConfirmSubscriptionBinding,
          AWS.SNS.GetDataProtectionPolicyBinding,
          AWS.SNS.GetSubscriptionAttributesBinding,
          AWS.SNS.GetTopicAttributesBinding,
          AWS.SNS.ListSubscriptionsByTopicBinding,
          AWS.SNS.ListSubscriptionsBinding,
          AWS.SNS.ListTagsForResourceBinding,
          AWS.SNS.ListTopicsBinding,
          AWS.SNS.PublishBatchBinding,
          AWS.SNS.PublishBinding,
          AWS.SNS.PutDataProtectionPolicyBinding,
          AWS.SNS.RemovePermissionBinding,
          AWS.SNS.SetSubscriptionAttributesBinding,
          AWS.SNS.SetTopicAttributesBinding,
          AWS.SNS.TagResourceBinding,
          AWS.SNS.UntagResourceBinding,
          AWS.SQS.SendMessageBatchBinding,
        ),
      ),
    ),
  ),
