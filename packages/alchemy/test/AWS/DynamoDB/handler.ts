...
export default DynamoDBTestFunction.make(
  ...
  Effect.gen(function* () {
    ...
    Effect.provide(
      Layer.mergeAll(
        DynamoDB.BatchExecuteStatementBinding,
        DynamoDB.BatchGetItemBinding,
        DynamoDB.BatchWriteItemBinding,
        DynamoDB.DescribeTableBinding,
        DynamoDB.DescribeTimeToLiveBinding,
        DynamoDB.ExecuteStatementBinding,
        DynamoDB.ExecuteTransactionBinding,
        DynamoDB.GetItemBinding,
        DynamoDB.ListTablesBinding,
        DynamoDB.ListTagsOfResourceBinding,
        DynamoDB.PutItemBinding,
        DynamoDB.DeleteItemBinding,
        DynamoDB.UpdateItemBinding,
        DynamoDB.UpdateTimeToLiveBinding,
        DynamoDB.QueryBinding,
        DynamoDB.RestoreTableToPointInTimeBinding,
        DynamoDB.ScanBinding,
        DynamoDB.TransactGetItemsBinding,
        DynamoDB.TransactWriteItemsBinding,
      ),
    ),
  ),
);
