...
// AWS association/disassociation and ENI cleanup can exceed the normal 90-second provisioning budget.
describe.skipIf(process.env.AWS_TEST_CLIENT_VPN_ASSOCIATION !== "1")(
  "Client VPN target networks (AWS_TEST_CLIENT_VPN_ASSOCIATION=1)",
  () => {
