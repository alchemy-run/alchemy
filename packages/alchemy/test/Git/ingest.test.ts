...
describe(
  "ingestPackFrom through the hasher",
  { tags: ["unit", "local"] },
  () => {
      ...
      await Effect.runPromise(
        Effect.gen(function* () {
          ...
          if (outcome._tag === "Failure")
            throw new Error(
              `${outcome.failure._tag}: ${outcome.failure.reason}`,
            );
...
describe(
  "hasher pipeline over a streaming source with eviction",
  { tags: ["unit", "local"] },
  () => {
    test(
...
describe(
  "raw-chunk dispatch with resync and stitching (DESIGN §22.9)",
  { tags: ["unit", "local"] },
  () => {
...
describe(
  "spill by the hasher (DESIGN §22.10)",
  { tags: ["unit", "local"] },
  () => {
