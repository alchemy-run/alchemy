 ...
 * (`@alchemy.run/web-frameworks/nextjs/source`).
 *
...
const PROVIDER = "@alchemy.run/web-frameworks/nextjs/source";
...
/**
 * The JSON-serializable options of the `@alchemy.run/web-frameworks/nextjs/source`
