...
<Section padding="8px 32px 48px" id="pick-your-cloud">
  <div style="text-align:center;margin-bottom:20px;">
    <Eyebrow>pick your cloud</Eyebrow>
  </div>
  ...
  <div class="alc-cloud-chips">
    <span class="alc-cloud-chips__label">Works with</span>
    <a class="alc-cloud-chip" href="/integrations/planetscale">PlanetScale</a>
    <a class="alc-cloud-chip" href="/integrations/neon">Neon</a>
    <a class="alc-cloud-chip" href="/integrations/axiom">Axiom</a>
    <a class="alc-cloud-chip" href="/integrations/github">GitHub</a>
  </div>
</Section>
