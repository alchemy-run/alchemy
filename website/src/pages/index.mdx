...
<div class="alc-split-2 alc-split-2--wide-left live-tests__split">
...
<Section padding="80px 32px" id="operational-readiness">
  ...
  <div class="alc-split-2 operational-readiness__split">
...
<Section padding="56px 32px 64px" id="outro">
	...
	<div class="alc-cta" style="margin-top:48px;text-align:center;">
		<h2 class="alc-h2 alc-outro-heading">
			<HeadingOrnament variant="fleuron" position="prefix" />
			<span class="alc-outro-heading__main">Paste this into your coding agent</span>
			<span class="alc-outro-heading__sub">to get started.</span>
		</h2>
    <CopyForAgent client:load />
    <div style="display:flex;gap:10px;justify-content:center;flex-wrap:wrap;margin-top:24px;">
      <Button variant="secondary" href="/getting-started">Read the tutorial</Button>
