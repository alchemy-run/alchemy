---
title: Git
description: A git server as Effect Layers on Cloudflare Workers, Durable Objects, and R2. Smart HTTP for any client, a typed REST plane with pull requests, and a GitHub-compatible API, assembled in one file.
---

`alchemy/Git` is a git server as a set of Effect Layers. It speaks git's
...
Cloudflare Workers, Durable Objects, and R2, in one file:
