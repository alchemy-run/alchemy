...
| Your own users and credentials | your `HttpApi` middleware and `Authenticate` | [Tutorial Part 3](/git/tutorial/part-3) |
| Branch rules, teams | your `Policy` | [Tutorial Part 4](/git/tutorial/part-4) |
