...
| Bytes stored in AWS | `BlobStoreS3({ bucket, region })` | [Bytes in S3, hashing on Lambda](/git/recipes/cloudflare-aws) |
...
| Branch rules, your own users | wrap or replace `AuthTokens` | [Tutorial Part 3](/git/tutorial/part-3) |
| Your web app and git on one domain | a front-door Worker | [Tutorial Part 4](/git/tutorial/part-4) |
