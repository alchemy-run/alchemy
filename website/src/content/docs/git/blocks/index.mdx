...
| --- | --- | --- |
| [HTTP routes](/git/blocks/server) | the HTTP surface: every plane as one `HttpApi` of routes you can replace, behind your middleware | `HandlersLive`, `ApiLive`, `InternalApiLive` |
