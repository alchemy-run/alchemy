---
title: Websites
description: Deploy Vite, Astro, Next.js, Nuxt, SvelteKit, Waku, Octane, Foldkit, Vocs, or any static build to Fly with first-class Website resources.
sidebar:
  label: Overview
  order: 1
---
