---
title: Setup
description: Install Alchemy and connect it to Fly.io — create an org, generate an API token, and store it in a profile.
---
...
The official environment variable is `FLY_API_TOKEN`.
