...
org slug is where Services create their Apps, and what `Fly.App`
uses when you omit `orgSlug` (Alchemy reads it from the current
token).
...
- [Tutorial part 1](/fly/tutorial/part-1) — deploy your first Service.
