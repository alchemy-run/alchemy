---
title: Websites
description: Deploy Vite, Astro, Next.js, Nuxt, SvelteKit, Waku, Octane, Foldkit, Vocs, or any static build to Hetzner with first-class Website resources.
sidebar:
  label: Overview
  order: 1
---
...
- [The Vite resource](/hetzner/frontend/vite) — assets-only SPA,
  `spa` / `errorPage`, sharing a Server.
