...
depends on the service alone. Provide a KV-backed Layer and a KV
Namespace is created and bound; provide a DynamoDB-backed Layer and a
Table is instead. The handler never changes.
