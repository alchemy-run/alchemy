...
your own — a Layer can own Resources and Bindings outright:
...
A handler that provides this Layer gets the namespace created, bound,
and hidden behind `JobService`. Swapping the storage is one line, in
the provide, not the handler:
