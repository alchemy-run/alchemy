...
:::tip
Resource declarations like `Cloudflare.R2.R2Bucket("Bucket")` are just
...
[s2][g]+[/g] [c]Bucket[/c]
[d]•[/d] [b]Bucket[/b] [d](Cloudflare.R2.R2Bucket)[/d]

Proceed?
◉ Yes ○ No
[d]•[/d] [b]Bucket[/b] [d](Cloudflare.R2.R2Bucket)[/d] [d]no change[/d]
