...
`pooledOrigin` components — see [Connections](/neon/connections) for
how to use them.
...
- [Connections](/neon/connections) — direct vs pooled URIs and
  feeding `origin` into Hyperdrive.
- [Migrations](/neon/migrations) — apply SQL migrations on the
