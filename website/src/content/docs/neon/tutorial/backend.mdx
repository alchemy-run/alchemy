...
Start with `src/resources.ts` in the [complete example](https://github.com/alchemy-run/alchemy/tree/main/examples/neon-tutorial). Resource declarations run inside an `Effect.gen`; importing this module does not create cloud infrastructure.
