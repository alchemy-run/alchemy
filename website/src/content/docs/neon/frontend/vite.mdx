---
title: Vite
description: Package a Vite client build as a Neon Function, with native Vite development.
sidebar:
  order: 1
---
...
or valid TLS; verify HTTPS separately. See
[`CustomDomain`](/providers/neon/customdomain).
