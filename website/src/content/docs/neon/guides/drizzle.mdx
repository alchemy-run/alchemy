...
Read [Preview branches per PR](/neon/guides/preview-branches) for branch provisioning, or [Neon SQL setup](/sql/providers/neon) for client discovery. The [Project](/providers/neon/project) and [Branch](/providers/neon/branch) references cover resource options.
