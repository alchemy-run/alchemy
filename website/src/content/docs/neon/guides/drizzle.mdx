...
[Migrations](/neon/migrations) for the tracking and hashing
details.
...
`pooledOrigin` shapes (see [Connections](/neon/connections)). On
...
directly — the [Add Drizzle ORM](/cloudflare/guides/drizzle) guide
...
- [Add Drizzle ORM](/cloudflare/guides/drizzle) — the full
...
- [Migrations](/neon/migrations) — how Neon orders, hashes, and
  tracks the generated files.
- [Connections](/neon/connections) — direct vs pooled origins.
