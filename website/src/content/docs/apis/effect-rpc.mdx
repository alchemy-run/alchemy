...
your stack. That validation has a per-request price: a frame parse,
...
bodies live on the hub pages: R2 in
...
group value with no codegen. Errors are typed: `client.getTask`
