...
[Providers](/concepts/provider) for the operation contract.
...
See [Resource lifecycle](/concepts/resource-lifecycle) for the
...
Full `test.provider` reference and patterns: [Testing Providers](/guides/testing-providers).
...
- [Actions](/concepts/action) — deploy-time work that isn't a
  resource.
- [Testing Providers](/guides/testing-providers) — the harness
  patterns behind `test.provider`.
- [Providers](/concepts/provider) — the operation contract this
  guide implements.
- [Bindings](/concepts/binding) — next up: connecting Resources to Functions.
