...
[Effect HTTP API](/cloudflare/guides/effect-http-api) for the
...
- [Multiple Stacks](/guides/monorepo-multi-stack) — split the
  deploy per package when cadences diverge.
- [File layout](/guides/file-layout) — the single-package layout
  this builds on.
- [Effect HTTP API](/cloudflare/guides/effect-http-api) — the
