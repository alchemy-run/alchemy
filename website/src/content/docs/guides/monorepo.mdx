...
Walkthrough: [Single Stack](/guides/monorepo-single-stack).
...
Walkthrough: [Multiple Stacks](/guides/monorepo-multi-stack).
...
- [File layout](/guides/file-layout) — the single-package layout
  both options build on.
- [Single Stack](/guides/monorepo-single-stack) — the full
