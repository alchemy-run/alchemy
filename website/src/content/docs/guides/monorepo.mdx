...
[Effect HTTP API](/cloudflare/guides/effect-http-api) for the long-form
walkthrough.
...
When to reach for this shape — and the stage-pinning decision — is
covered in [Stack References](/guides/stack-references); this
section applies it to the two-package app.
...
hood it's [`Output.stackRef`](/concepts/references) reading
...
[Stack References](/guides/stack-references#wire-a-monorepos-stacks-together).
...
- [File layout](/guides/file-layout) — the single-package layout this builds on.
- [Stack References](/guides/stack-references) — when to split stacks and how to pin stages.
- [Resource lifecycle](/concepts/resource-lifecycle) — what happens when you run `deploy`.
- [Stacks](/concepts/stack) — defining stacks and stack outputs.
- [Stages](/concepts/stages) — naming and isolating per-environment deploys.
