...
Your code runs on your machine, so logs and stack traces come
straight from the local process (workerd or the Docker container).
...
| Debugging           | Local logs and stack traces              | Tail logs          |
