...
- [Foldkit](/cloudflare/frontend/foldkit) — Foldkit apps via
  `Website.Foldkit`; client-only, server-rendered, or prerendered,
  with asset routing derived from the build.
