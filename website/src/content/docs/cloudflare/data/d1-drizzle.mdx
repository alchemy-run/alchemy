...
See [Cloudflare SQL options](/sql/providers/cloudflare), the [D1 resource](/cloudflare/data/d1), or the [existing D1 example](https://github.com/alchemy-run/alchemy/tree/main/examples/cloudflare-d1-drizzle).
