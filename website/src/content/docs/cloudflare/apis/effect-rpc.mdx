...
See the [RPC Worker tutorial](/cloudflare/compute/workers#schemaless-rpc) for an
...
See the [RPC Durable Object tutorial](/cloudflare/compute/durable-objects#schemaless-rpc)
