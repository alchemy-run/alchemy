...
Return a stateful object and call its Effect and Stream methods. See [RPC objects](/cloudflare/apis/rpc-objects) for the counter service, caller, and scope lifetime.
