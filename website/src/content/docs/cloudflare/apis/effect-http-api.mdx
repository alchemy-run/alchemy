...
concept home is [Effect HTTP](/rpc/effect-http), and
[RPC](/rpc) covers choosing between the modalities.
...
- [Effect HTTP](/rpc/effect-http) — the concept home for this modality.
- [RPC](/rpc) — how to choose between Schemaless RPC, Effect RPC, and
  Effect HTTP.
