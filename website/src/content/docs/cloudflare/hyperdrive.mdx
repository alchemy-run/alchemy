...
inside Cloudflare, use [D1](/cloudflare/d1) instead.) This page
...
- The fetch handler opens a fresh connection per request and ends
  ...
  own. (The [Drizzle guide](/cloudflare/guides/drizzle) revisits
...
- [Add Drizzle ORM](/cloudflare/guides/drizzle) — swap the raw
...
- [PlanetScale](/integrations/planetscale)
