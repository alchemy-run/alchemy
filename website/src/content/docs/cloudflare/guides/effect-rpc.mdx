...
The [HTTP API guide](/cloudflare/guides/effect-http-api) showed how to build
...
See the [RPC Worker tutorial](/cloudflare/workers#schemaless-rpc) for an
...
See the [RPC Durable Object tutorial](/cloudflare/durable-objects#schemaless-rpc)
