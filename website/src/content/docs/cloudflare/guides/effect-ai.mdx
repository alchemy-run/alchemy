...
The [AI Gateway tutorial](/cloudflare/guides/ai-gateway) walks
...
- [Add an AI Gateway](/cloudflare/guides/ai-gateway) — wire
  Workers AI behind a Cloudflare AI Gateway with caching and
  streaming.
- [Secrets & env](/cloudflare/secrets-env) — how `Config.redacted`
