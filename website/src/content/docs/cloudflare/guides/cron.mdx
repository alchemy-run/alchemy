...
- [Workers](/cloudflare/workers) — the two-phase Worker model that
  cron handlers live inside.
- [Durable Objects](/cloudflare/durable-objects) — the stateful
  building block the test uses to record fires.
- [Workflows](/cloudflare/guides/workflows) — for multi-step jobs
