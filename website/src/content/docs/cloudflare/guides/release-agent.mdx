...
[`GitHub.consumeRepositoryEvents`](/cloudflare/guides/github-events)
...
[Durable Object](/cloudflare/durable-objects) keyed by the commit
...
[Cloudflare Container](/cloudflare/guides/containers) with a typed
...
- [React to GitHub events](/cloudflare/guides/github-events) — the
  event source in depth: provisioning, signatures, typed payloads.
- [Workflows](/cloudflare/guides/workflows) — durable multi-step
  execution if a release pipeline outgrows a single DO method.
- [Containers](/cloudflare/guides/containers) — the DevBox pattern:
