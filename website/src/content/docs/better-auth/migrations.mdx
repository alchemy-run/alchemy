...
Adding a required column with no default to a populated table is refused
(for example `account.issuer`). Complete the
[upgrade-guide backfill](https://www.better-auth.com/docs/guides/1-7-upgrade-guide)
before re-deploying.
