---
title: "Part 5: Add GitHub sign-in"
description: Register a GitHub OAuth app, bind its credentials through Effect Config, and sign in from the browser.
sidebar:
  order: 5
---
...
+  return yield* BetterAuth(authOptions);
+});
```
