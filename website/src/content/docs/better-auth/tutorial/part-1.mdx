---
title: "Part 1: Create an Auth service"
description: Install Better Auth, provide a D1 database layer, and create an Effect service.
sidebar:
  order: 1
---
...
Use [Bun](https://bun.sh) and a [configured Cloudflare profile](/cloudflare/setup). The examples use Effect 4 and Better Auth 1.7.5.
