---
title: "Part 6: Deploy and verify"
description: Deploy the authenticated API, configure production OAuth callbacks, and verify session boundaries.
sidebar:
  order: 6
---
...
Add verification and password reset through [email/password authentication](/better-auth/sign-in-providers/email-password). Use [authorization](/better-auth/guides/authorization) for ownership checks and [testing](/better-auth/guides/testing) for repeatable cookie-based checks.
