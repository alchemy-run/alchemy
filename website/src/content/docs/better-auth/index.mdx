---
title: Better Auth
description: Build authentication with an Effect service, automatic database bindings, and deploy-time migrations.
---
...
Read [HTTP API middleware](/better-auth/guides/http-api-middleware), [authorization](/better-auth/guides/authorization), and [plugins](/better-auth/guides/plugins) when adding protected features. Use [configuration](/better-auth/guides/configuration) for overrides rather than repeating Alchemy's automatic setup.
