...
traffic, and you bring a VPC (subnets + security groups). ECS is
documented through the generated reference pages above rather
than a walkthrough track.
...
internet gateways, route tables, EIPs, and VPC endpoints.

You own patching, scaling, and availability. Like ECS, EC2 is
documented through the generated reference pages rather than a
walkthrough track.
...
- [Lambda](/aws/lambda) — deploy a function with a public URL.
- [AWS overview](/aws) — building blocks and recipes.
