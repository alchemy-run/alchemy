...
[DynamoDB Streams guide](/aws/guides/dynamodb-streams)).

The walkthrough below builds on the [Lambda](/aws/lambda) and
[S3](/aws/s3) pages: it adds a **Table** and binds `GetItem` +
...
- [Process DynamoDB Streams](/aws/guides/dynamodb-streams) —
  ...
  react to.
- [SQS](/aws/sqs) — a general-purpose queue for background
