...
The [Deploy a Lambda Function](/aws/lambda) tutorial uses a **Function URL** for HTTP. Many teams still use **Amazon API Gateway** (REST, v1) as the front door.
...
- **Custom domains:** covered [above](#custom-domain); see also the [custom domains guide](/aws/guides/custom-domains).
