...
HTTP endpoint — which the [S3](/aws/s3),
[DynamoDB](/aws/dynamodb), [SQS](/aws/sqs), and
[Kinesis](/aws/kinesis) pages then grow into a small
event-driven system.
