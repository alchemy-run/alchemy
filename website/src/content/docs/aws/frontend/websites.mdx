---
title: Websites
description: Deploy Vite, Astro, Next.js, Nuxt, React Router, SolidStart, SvelteKit, TanStack Start, Waku, Octane, or any static build to AWS with first-class Website resources.
sidebar:
  label: Overview
  order: 1
---
...
- [`SolidStart`](/aws/frontend/solidstart) — SolidStart apps built
  through nitro's `aws-lambda` preset.
...
| SolidStart | `SolidStart` | [SolidStart](/aws/frontend/solidstart) |
...
`Nuxt`, `ReactRouter`, `SolidStart`, `SvelteKit`, `TanStackStart`,
...
- Framework guides:
  ...
  [SolidStart](/aws/frontend/solidstart),
