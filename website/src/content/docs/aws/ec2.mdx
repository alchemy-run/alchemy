...
[Lambda](/aws/lambda) and [ECS](/aws/ecs), you own patching,
...
background loops work exactly as they do on [ECS](/aws/ecs).
...
- [Choosing a runtime](/aws/choosing-a-runtime) — Lambda first,
