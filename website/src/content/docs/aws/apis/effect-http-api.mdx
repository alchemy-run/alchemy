...
[Effect HTTP](/rpc/effect-http), and [RPC](/rpc) covers choosing
...
- [Effect HTTP](/rpc/effect-http) — the concept home: endpoints,
  groups, handlers, and typed clients, independent of any host.
- [RPC](/rpc) — deciding between schemaless RPC, Effect RPC, and
  Effect HTTP.
