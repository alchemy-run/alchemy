...
[Schemaless RPC](/rpc/schemaless) instead (on AWS, a Lambda Function
driving a [MicroVM](/aws/compute/microvms)); the
[RPC overview](/rpc) has the full decision.
...
[Effect RPC](/rpc/effect-rpc) covers the host-agnostic core; this
...
- **Internal service-to-service calls** —
  [Schemaless RPC](/rpc/schemaless).
- **The full decision** — [RPC overview](/rpc).
