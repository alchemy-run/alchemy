...
[SQS](/aws/sqs) instead when the work is unordered.

The walkthrough below builds on the [Lambda](/aws/lambda),
[DynamoDB](/aws/dynamodb), and [SQS](/aws/sqs) pages: it adds a
...
[SQS `consumeQueueMessages(...)`](/aws/sqs) shape.
...
- [Process DynamoDB Streams](/aws/guides/dynamodb-streams) —
  change data capture with the same consumer surface.
- [React to S3 events](/aws/guides/s3-events) — bucket
