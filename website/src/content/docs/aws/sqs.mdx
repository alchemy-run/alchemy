...
[DynamoDB](/aws/dynamodb) pages: it adds a **Queue**, sends
...
- [Kinesis](/aws/kinesis) — stream higher-volume records:
  ordered, sharded, and with the same `Stream` consumer surface.
- [Process DynamoDB Streams](/aws/guides/dynamodb-streams) — the
