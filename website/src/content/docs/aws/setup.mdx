---
title: Setup
description: Connect Alchemy to AWS with SSO, console login, stored access keys, or CI environment credentials.
---
...
Alchemy runs `aws login --profile <name>` (AWS CLI v2.32+) and
