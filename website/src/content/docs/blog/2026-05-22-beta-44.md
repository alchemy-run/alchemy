...
category: release
excerpt: v2.0.0-beta.44 adds a new `Cloudflare.Zaraz.ZarazConfig` resource, a bundle analyzer for Workers, and Artifacts binding support in dev, plus a handful of bundler and dev-server fixes.
---

`v2.0.0-beta.44` is a polish release. Two new things worth
calling out — a new **`Cloudflare.Zaraz.ZarazConfig`** resource and a
...
- **[Alex](https://github.com/gogl-alex)** — `Cloudflare.Zaraz.ZarazConfig` ([#371](https://github.com/alchemy-run/alchemy-effect/pull/371))
