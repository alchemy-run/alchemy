...
services** — in one release cycle. The tests didn't just verify the
resources; they compiled Cloudflare's *actual* API behavior into the
type system, for every future consumer of the SDK.

The full story — the factory, the flywheel, what broke at scale, and
what the agents didn't do — is in
[Generating 200+ Cloudflare Resources with AI](/blog/2026-07-02-cloudflare-resource-factory).
