...
[Effect AI](/cloudflare/guides/effect-ai) provider, and fixes streaming
...
The [Effect AI guide](/cloudflare/guides/effect-ai) covers the provider
pattern (reading keys with `Config.redacted`, chat persistence),
and the [AI Gateway tutorial](/cloudflare/guides/ai-gateway)
...
- [Effect AI guide](/cloudflare/guides/effect-ai)
- [AI Gateway tutorial](/cloudflare/guides/ai-gateway)
