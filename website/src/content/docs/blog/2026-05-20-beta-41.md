...
so the schema-driven pattern in the [HTTP API](/cloudflare/guides/effect-http-api)
and [RPC](/cloudflare/guides/effect-rpc) guides now holds together under
real traffic.
...
The pattern the [HTTP API guide](/cloudflare/guides/effect-http-api) and
[RPC guide](/cloudflare/guides/effect-rpc) describe — define a schema, build
...
- [Effect HTTP API](/cloudflare/guides/effect-http-api) — schema → endpoints
  → Worker → typed client, plus the DO-backed variant.
- [Effect RPC](/cloudflare/guides/effect-rpc) — schema → procedures →
...
- [Effect HTTP API guide](/cloudflare/guides/effect-http-api)
- [Effect RPC guide](/cloudflare/guides/effect-rpc)
