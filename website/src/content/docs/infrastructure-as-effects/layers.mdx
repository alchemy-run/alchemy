...
to a Worker or Lambda ([Functions & Servers](/infrastructure-as-effects/platform)).
...
the program won't type-check. Functions and Layers fit together by
type, not by convention.

## Runtime as a colored function

A Worker or Lambda program has two [Phases](/infrastructure-as-effects/phases): the **init**
...
clients, IAM, env injection — see [Binding](/infrastructure-as-effects/binding). For
