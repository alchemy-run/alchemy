...
In this guide, which builds on [Bindings](/infrastructure-as-effects/binding), you'll
...
([Functions & Servers](/infrastructure-as-effects/platform)), not just Workers.
...
- [Layers](/infrastructure-as-effects/layers) — package resources behind service interfaces.
