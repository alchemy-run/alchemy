---
title: Phases
description: Alchemy programs run in two phases — plantime/construct drives the deploy, runtime handles requests. Knowing which is which is the key to writing Workers and Lambda Functions.
---
...
| --------- | ------ | ------------------------------------- |
| Construct | outer  | At plantime **and** at cold start     |
