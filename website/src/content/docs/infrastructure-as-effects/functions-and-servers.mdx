...
Treat it as pure assembly: resolve services, build clients, return
handlers. Don't perform I/O or acquire connections there.

Each event then runs your handler with a **fresh `Scope`**. Anything
that needs I/O or cleanup belongs here — acquired lazily, released
