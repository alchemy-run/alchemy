...
- [Layers](/infrastructure-as-effects/layers) — hide bindings behind a service interface. Next page.
- [Event Sources](/infrastructure-as-effects/event-sources) — bindings that trigger your Function.
