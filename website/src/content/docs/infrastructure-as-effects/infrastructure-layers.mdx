...
- [Functions & Servers](/infrastructure-as-effects/platform) — the Worker/Lambda model these Layers plug into.
- [Layers](/infrastructure-as-effects/layers) — the concept behind this guide.
