...
Choose a database in [SQL databases](/sql/databases), then follow [AWS](/sql/providers/aws), [Cloudflare](/sql/providers/cloudflare), [Fly](/sql/providers/fly), [Neon](/sql/providers/neon), [PlanetScale](/sql/providers/planetscale), [Prisma](/sql/providers/prisma), or [Railway](/sql/providers/railway) for connection and deployment setup. These choices do not change the client's scope-based lifecycle.
