...
Choose a MySQL-compatible database in [SQL databases](/sql/databases); [AWS](/sql/providers/aws), [Cloudflare](/sql/providers/cloudflare), [PlanetScale](/sql/providers/planetscale), and [Railway](/sql/providers/railway) cover provider setup. Those pages own provisioning and deployment; the client above only needs a connection URL.
