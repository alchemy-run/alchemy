...
Choose [database setup](/sql/databases) for [AWS](/sql/providers/aws), [Cloudflare](/sql/providers/cloudflare), [Fly](/sql/providers/fly), [Neon](/sql/providers/neon), [PlanetScale](/sql/providers/planetscale), [Prisma](/sql/providers/prisma), or [Railway](/sql/providers/railway). Those pages own provisioning and deployment; the client above only needs a connection URL.
