...
Choose a MySQL-compatible database in [SQL databases](/sql/databases); [AWS](/sql/providers/aws), [Cloudflare](/sql/providers/cloudflare), [PlanetScale](/sql/providers/planetscale), and [Railway](/sql/providers/railway) cover provider setup. For tagged-template queries without an ORM, use [Effect SQL: MySQL](/sql/effect-sql/mysql).
