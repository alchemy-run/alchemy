...
and how the graph deploys — see [Resources](/concepts/resource) and
[Resource lifecycle](/concepts/resource-lifecycle). To hide
resources and their Outputs behind a service interface, continue to
[Layers](/concepts/layers).

## Where next

- [Layers](/concepts/layers) — hide resources and their Outputs behind a service interface.
- [References](/concepts/references) — read Outputs across stacks and stages.
- [Resource lifecycle](/concepts/resource-lifecycle) — how the graph deploys.
