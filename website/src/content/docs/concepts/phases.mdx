...
:::tip
Read this after [Functions & Servers](/concepts/platform). The init/runtime
...
[Bindings](/concepts/binding). Next: where all of this is
persisted — [State Store](/concepts/state-store).

## Where next

- [State Store](/concepts/state-store) — where deploy results persist between runs.
- [Bindings](/concepts/binding) — what `bind(resource)` records at plantime.
- [Layers](/concepts/layers) — runtime as a colored function.
