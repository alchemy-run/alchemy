...
[state store](/concepts/state-store) at plan time. References are
...
[Output](/concepts/outputs) flow with one difference: a reference's
...
- [Inputs & Outputs](/concepts/outputs) — the Output model
