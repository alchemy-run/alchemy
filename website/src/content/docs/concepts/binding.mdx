...
[Functions & Servers](/concepts/platform)).
...
[Functions & Servers › Bindings in action](/concepts/platform#bindings-in-action).
...
[Layers](/concepts/layers) covers. When two Workers bind each
other, see [Circular Bindings](/guides/circular-bindings).

## Where next

- [Circular Bindings](/guides/circular-bindings) — two Workers that bind each other.
- [Layers](/concepts/layers) — hide bindings behind a service interface.
- [Phases](/concepts/phases) — when the deploy-time wiring runs vs the runtime client.
