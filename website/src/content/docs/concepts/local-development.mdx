...
`dev` deploys into your personal [stage](/concepts/stages)
...
To automate the deploy side, see the [CI guide](/guides/ci).

## Where next

- [CI](/guides/ci) — deploy the same stack from GitHub Actions with PR previews.
- [Stages](/concepts/stages) — how `dev_$USER`, `pr-42`, and `prod` stay isolated.
