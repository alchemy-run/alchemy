...
function Nav({ currentTrack }) {
  const links = [
    ...
    { href: "effect.html", label: "Effect" },
    { href: "iac.html", label: "IaC" },
...
function TweaksPanel({ currentTrack }) {
  ...
  const tracks = [
    { key: "overview", label: "Overview (index)", file: "index.html" },
    { key: "effect",   label: "1. Effect community", file: "effect.html" },
    { key: "iac",      label: "2. IaC comparison", file: "iac.html" },
    { key: "cloud",    label: "3. Cloud-first", file: "cloud.html" },
    { key: "ai",       label: "4. AI vibe-coders", file: "ai.html" },
  ];
  return (
    <div style={{
