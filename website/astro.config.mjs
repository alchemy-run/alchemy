      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "Client generation", link: "/prisma/generate" },
            { label: "Query with Effect", link: "/prisma/effect" },
            { label: "Async Workers", link: "/prisma/async" },
            { label: "Effect schemas", link: "/prisma/effect-schemas" },
            {
              label: "Adopt an existing project",
              link: "/prisma/adopt",
            },
